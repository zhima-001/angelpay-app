...
$zhifu_url = $full_domain."/pay/".$chajian."/qrcode/{$trade_no}/";
...
echo "<script>window.location.href='/pay/".$chajian."/qrcode/{$trade_no}/?sitename={$sitename}';</script>";
