...
$native = array(
        ...
        "orderId" => TRADE_NO, 
        "notifyUrl" => $huidiaourl."pay/yangguangdianyuan/notify/".TRADE_NO.'/',
        "returnUrl"=>$huidiaourl."pay/yangguangdianyuan/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"指南针支付","下单");
