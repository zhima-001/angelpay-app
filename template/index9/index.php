...
if(!defined('IN_CRONLITE'))exit();
    	define('AUTH_API_URL', 'http://auth.76vf.cn/api.php');
                    ...
                    <div class="plan">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <h2 class="plan-pricing"><?php echo $conf['reg_pay_price']?>元<span>由鲸落云支付收取注册费用</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="plan">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <h2 class="plan-pricing">3%<span>由鲸落云支付官方收取</span></h2>
