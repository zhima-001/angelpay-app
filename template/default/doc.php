...
<p>URL地址：<?php echo $siteurl?>qrcode.php?pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;name={商品名称}&amp;money={金额}&amp;sign={签名字符串}&amp;sign_type=MD5&amp;stype={通道编码}&amp;request_method={返回信息格式}<</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>是否必须加入签名</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>支付方式</td><td>type</td><td>是</td><td>是</td><td>String</td><td>alipay</td><td>qqpay:QQ钱包,wxpay:微信支付</td></tr>
  <tr><td>商户订单号</td><td>out_trade_no</td><td>是</td><td>是</td><td>String</td><td>20160806151343349</td><td></td></tr>
  <tr><td>异步通知地址</td><td>notify_url</td><td>是</td><td>是</td><td>String</td><td>http://www.cccyun.cc/notify_url.php</td><td>服务器异步通知地址</td></tr>
  <tr><td>商品名称</td><td>name</td><td>是</td><td>是</td><td>String</td><td>VIP会员</td><td></td></tr>
  <tr><td>商品金额</td><td>money</td><td>是</td><td>是</td><td>String</td><td>1.00</td><td></td></tr>
  <tr><td>签名字符串</td><td>sign</td><td>是</td><td>否</td><td>String</td><td>202cb962ac59075b964b07152d234b70</td><td>签名算法与<a href="https://doc.open.alipay.com/docs/doc.htm?treeId=62&articleId=104741&docType=1" target="_blank" style="color:red">支付宝签名算法[且stype参数不加入签名，单独]</a>相同</td></tr>
  <tr><td>签名类型</td><td>sign_type</td><td>是</td><td>否</td><td>String</td><td>MD5</td><td>默认为MD5</td></tr>
   <tr><td>通道编码</td><td>stype</td><td>否</td><td>否</td><td>String</td><td>0</td><td>默认为0<span style="color:red">【通道编码不加入签名校验】</span></td></tr>
   <tr><td>返回信息格式</td><td>request_method</td><td>否</td><td>否</td><td>String</td><td>空或者JSON</td><td>默认为HTML<span style="color:red">【返回信息格式不加入签名校验】</span></td></tr>
  </tbody>
</table>
<p>返回结果：</p>
<table class="table table-bordered table-hover">
...
<hr/>
		...
		<div id="pay0" class="api_block">
			<h3>
				发起支付请求<span style="color:red">[建议：GET提交,如POST提交务必表单数据提交支付]</span>
			</h3>
<p>URL地址：<?php echo $siteurl?>submit.php</p>
<p>POST数据：pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;return_url={页面跳转通知地址}&amp;name={商品名称}&amp;money={金额}&amp;sitename={网站名称}&amp;sign={签名字符串}&amp;sign_type=MD5&amp;stype={通道编码}&amp;request_method={返回信息格式}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>是否必须加入签名</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>支付方式</td><td>type</td><td>是</td><td>是</td><td>String</td><td>alipay</td><td>alipay:支付宝,tenpay:财付通,<br/>qqpay:QQ钱包,wxpay:微信支付</td></tr>
  <tr><td>商户订单号</td><td>out_trade_no</td><td>是</td><td>是</td><td>String</td><td>20160806151343349</td><td></td></tr>
  <tr><td>异步通知地址</td><td>notify_url</td><td>是</td><td>是</td><td>String</td><td>http://www.cccyun.cc/notify_url.php</td><td>服务器异步通知地址</td></tr>
  <tr><td>跳转通知地址</td><td>return_url</td><td>是</td><td>是</td><td>String</td><td>http://www.cccyun.cc/return_url.php</td><td>页面跳转通知地址</td></tr>
  <tr><td>商品名称</td><td>name</td><td>是</td><td>是</td><td>String</td><td>VIP会员</td><td></td></tr>
  <tr><td>商品金额</td><td>money</td><td>是</td><td>是</td><td>String</td><td>1.00</td><td></td></tr>
  <tr><td>网站名称</td><td>sitename</td><td>否</td><td>是</td><td>String</td><td>彩虹云任务</td><td></td></tr>
  <tr><td>签名字符串</td><td>sign</td><td>是</td><td>否</td><td>String</td><td>202cb962ac59075b964b07152d234b70</td><td>签名算法与<a href="https://doc.open.alipay.com/docs/doc.htm?treeId=62&articleId=104741&docType=1" target="_blank" style="color:red">支付宝签名算法[且stype参数不加入签名，单独]</a>相同</td></tr>
  <tr><td>签名类型</td><td>sign_type</td><td>是</td><td>否</td><td>String</td><td>MD5</td><td>默认为MD5</td></tr>
  <tr><td>通道编码</td><td>stype</td><td>否</td><td>否</td><td>String</td><td>0</td><td>默认为0<span style="color:red">【通道编码不加入签名校验】</span></td></tr><tr><td>返回信息格式</td><td>request_method</td><td>否</td><td>否</td><td>String</td><td>空或者JSON</td><td>默认为0<span style="color:red">【返回信息格式不加入签名校验】</span></td></tr>
  </tbody>
</table>
		</div>
...
<p>请求方式：GET</p>
<p>请求参数说明：只需要返回<span style="color:red">success</span>，确定回调成功！</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  ...
  <tr><td>签名字符串</td><td>sign</td><td>是</td><td>String</td><td>202cb962ac59075b964b07152d234b70</td><td>签名算法与<a href="https://doc.open.alipay.com/docs/doc.htm?treeId=62&articleId=104741&docType=1" target="_blank" style="red">支付宝签名算法</a>相同</td></tr>
...
<hr/>
		...
		<div id="sdk0" class="api_block">
			<h3>
                ...
                <blockquote>
                <a href="./SDK2.rar" style="color:blue">SDK2.zip</a><br/>
