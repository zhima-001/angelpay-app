...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/dahuagufen/notify/".TRADE_NO.'/',
        "pay_callbackurl"=>$huidiaourl."pay/dahuagufen/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"大华股份支付","下单");
...
<script data-savepage-type="" type="text/plain" data-savepage-src="../../assets/js/new/jquery.min.js"></script>
