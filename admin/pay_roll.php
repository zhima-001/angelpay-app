...
$paytype = [];
//红，粉，紫，蓝，黄，橙，绿，黑
$paytype_yanse = ["红色"=>"红色","粉色"=>"粉色","紫色"=>"紫色","蓝色"=>"蓝色","黄色"=>"黄色","橙色"=>"橙色","绿色"=>"绿色","黑色"=>"黑色"];
$type_select = '';
...
$list = $DB->getAll("SELECT * FROM pre_roll  order by dijige asc,id asc");
?>
			...
			<div class="modal-body">
				<form class="form-horizontal" id="form-store">
					...
					<div class="form-group ">
						...
						<div class="col-sm-10">
								<input type="text" class="form-control" name="zuming" id="zuming" placeholder="仅显示使用，组名">
						</div>
					</div>
					<div class="form-group ">
						<label class="col-sm-2 control-label">颜色</label>
						<div class="col-sm-10">
								<!--<input type="text" class="form-control" name="yanse" id="yanse" placeholder="仅显示使用，颜色">-->
						   <select id="yanse" name="yanse"  class="form-control">
						       <!--红，粉，紫，蓝，黄，橙，绿，黑-->
   ...
   <div class="panel-heading"><h3 class="panel-title">系统共有 <b><?php echo count($list);?></b> 个轮询组&nbsp;<span class="pull-right"><a href="javascript:addframe()" class="btn btn-default btn-xs"><i class="fa fa-plus"></i> 新增</a></span></h3></div>
      <div class="table-responsive">
        <table class="table table-striped">
          <thead><tr><th>ID</th><th>显示名称</th><th>支付方式</th><th>轮询方式</th><th>轮询规则</th><th>组名</th><th>状态</th><th>操作</th></tr></thead>
          <tbody>
<?php
foreach($list as $res)
{ 
    if($res['yanse'] =="红色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:red;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }elseif($res['yanse'] =="粉色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:pink;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }elseif($res['yanse'] =="紫色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:purple;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }elseif($res['yanse'] =="蓝色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:blue;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }elseif($res['yanse'] =="黄色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:yellow;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }elseif($res['yanse'] =="橙色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:orange;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }elseif($res['yanse'] =="绿色"){
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:green;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }else{
        echo '<tr><td><b>'.$res['id'].'</b></td><td>'.$res['name'].'</td><td>'.$paytype[$res['type']].'</td><td>'.$rolltype[$res['kind']].'</td><td>'.$res['info'].'</td><td style="color:red"><div style="width:15px;height:15px;background-color:black;float:left;margin-top:3px"></div>'.$paytype_yanse[$res['zuming']].'</td><td>'.($res['status']==1?'<a class="btn btn-xs btn-success" onclick="setStatus('.$res['id'].',0)">已开启</a>':'<a class="btn btn-xs btn-warning" onclick="setStatus('.$res['id'].',1)">已关闭</a>').'</td><td><a class="btn btn-xs btn-primary" onclick="editInfo('.$res['id'].')">配置通道</a>&nbsp;<a class="btn btn-xs btn-info" onclick="editframe('.$res['id'].')">编辑</a>&nbsp;<a class="btn btn-xs btn-danger" onclick="delItem('.$res['id'].')">删除</a>  <input value="'.$res['dijige'].'" onchange="setStatus_Q('.$res['id'].',this)" class="input" style="width:38px"></td></tr>';
    }
...
function setStatus_Q(id,that) {
	...
	$.ajax({
		type : 'GET',
		url : 'ajax.php?act=setChannel_S2&id='+id+'&dijige='+dijige,
		dataType : 'json',
	...
	$.ajax({
		...
		success : function(data) {
			...
			if(data.code == 0){
				...
				$("#zuming").val(data.data.zuming);
				$("#yanse").val(data.data.yanse);
			}else{
	...
	$.ajax({
		...
		success : function(data) {
			...
			if(data.code == 0){
				...
				var area = [$(window).width() > 520 ? '650px' : '100%', '480px'];
				layer.open({
				  type: 1,
				  area: area,
				  title: '配置轮询组',
				  ...
				  success: function(){
					  if(data.info == null){
						$(".fieldlist").append('<dd class="form-inline"><select name="list[0][channel]" class="form-control">'+$("#channel").html()+'</select> <input type="text" name="list[0][weight]" class="form-control" value="" size="10" placeholder="权重(1-99)"> <input type="text" name="list[0][prices]" class="form-control" value="" size="10" placeholder="金额列表"> <input type="text" name="list[0][terminals]" class="form-control" value="" size="10" placeholder="终端权重列表"><span class="btn btn-sm btn-danger" disabled><i class="fa fa-times"></i></span> </dd>');
					  }else{
						$.each(data.info, function (i, res) {
							var num = parseInt(Math.random()*(99999-10+1)+10,10);
							console.log(res);
							$(".fieldlist").append('<dd class="form-inline"><select name="list['+num+'][channel]" class="form-control" default="'+res.channel+'">'+$("#channel").html()+'</select> <input type="text" name="list['+num+'][weight]" class="form-control" value="'+res.weight+'" size="10" placeholder="权重(1-99)"> <input type="text" name="list['+num+'][prices]" class="form-control" value="'+res.prices+'" size="10" placeholder="金额列表"> <input type="text" name="list['+num+'][terminals]" class="form-control" value="'+res.terminals+'" size="10" placeholder="终端权重列表"><span class="btn btn-sm btn-danger btn-remove"><i class="fa fa-times"></i></span> </dd>');
...
$(document).on("click", ".pay-append", function (e) {
	...
	var num = parseInt(Math.random()*(99999-10+1)+10,10);
	var html = '<dd class="form-inline"><select name="list['+num+'][channel]" class="form-control">'+select+'</select> <input type="text" name="list['+num+'][weight]" class="form-control" value="" size="10" placeholder="权重(1-99)"> <input type="text" name="list['+num+'][prices]" class="form-control" value="" size="10" placeholder="金额列表">  <input type="text" name="list['+num+'][terminals]" class="form-control" value="" size="10" placeholder="终端权重列表">  <span class="btn btn-sm btn-danger btn-remove"><i class="fa fa-times"></i></span> </dd>';
