...
<div class="panel-body">
  <form onsubmit="return saveSetting(this)" method="post" class="form-horizontal" role="form">
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:green">t0不可结算限额:默认5000</label>
	  <div class="col-sm-10"><input type="text" name="tojiesuan" value="<?php echo $conf['tojiesuan']; ?>" class="form-control" required/></div>
	</div><br/> 
    <div class="form-group">
	  <label class="col-sm-2 control-label">网站是否开启页面</label>
	  <div class="col-sm-10"><select class="form-control" name="shangqiantai" default="<?php echo $conf['shangqiantai']?>"><option value="0">不开启</option><option value="1">开启</option></select></div> 
	</div><br/>
	 <div class="form-group"> 
	  <label class="col-sm-2 control-label">网站是否开启商户后台</label>
	  <div class="col-sm-10"><select class="form-control" name="shanghuhou" default="<?php echo $conf['shanghuhou']?>"><option value="0">不开启</option><option value="1">开启</option></select></div> 
	</div><br/>
	<div class="form-group">
	  <label class="col-sm-2 control-label">是否开启自定义日期下发</label>
	  <div class="col-sm-10"><select class="form-control" name="zidingyixiafa" default="<?php echo $conf['zidingyixiafa']?>"><option value="0">不开启</option><option value="1">开启</option></select></div>
	</div><br/>
	<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:blue">通道多少分钟没订单自动关闭:默认7200</label>
	  <div class="col-sm-10"><input type="text" name="jisuanshijian" value="<?php echo $conf['jisuanshijian']; ?>" class="form-control" required/></div>
	</div><br/> 
	
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">下发时间日期填写,格式如下：2024-4-26</label>
	  <div class="col-sm-10"><input type="text" name="xiafariqi" value="<?php echo $conf['xiafariqi']; ?>" class="form-control" required/></div>
	</div><br/> 
    
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">token设置</label>
	  <div class="col-sm-10"><input type="text" name="token" value="<?php echo $conf['token']; ?>" class="form-control" required/></div>
	</div><br/>  
	<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">ownerAddress设置</label>
	  <div class="col-sm-10"><input type="text" name="ownerAddress" value="<?php echo $conf['ownerAddress']; ?>" class="form-control" required/></div>
	</div><br/>  
    
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">通知商户支付成功的地址设置1</label>
	  <div class="col-sm-10"><input type="text" name="tongzhishanghu" value="<?php echo $conf['tongzhishanghu']; ?>" class="form-control" required/></div>
	</div><br/>  
    
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">通知商户支付成功的地址设置2</label>
	  <div class="col-sm-10"><input type="text" name="tongzhishanghu2" value="<?php echo $conf['tongzhishanghu2']; ?>" class="form-control" required/></div>
	</div><br/>  
    
    
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">回调地址设置</label>
	  <div class="col-sm-10"><input type="text" name="huidiaourl" value="<?php echo $conf['huidiaourl']; ?>" class="form-control" required/></div>
	</div><br/>  
      
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:blue">Json下单网关地址：</label>
	  <div class="col-sm-10"><input type="text" name="jsondiaourl" value="<?php echo $conf['jsondiaourl']; ?>" class="form-control" required/></div>
	</div><br/>  
    <div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">A群Chat_id设置</label>
	  <div class="col-sm-10"><input type="text" name="achatid" value="<?php echo $conf['achatid']; ?>" class="form-control" required/></div>
	</div><br/>  
	
	<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">B群Chat_id设置</label>
	  <div class="col-sm-10"><input type="text" name="bchatid" value="<?php echo $conf['bchatid']; ?>" class="form-control" required/></div>
	</div><br/>  
	
		<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:green">qq微信支付宝限制域名</label>
	  <div class="col-sm-10"><input type="text" name="appxianzhi" value="<?php echo $conf['appxianzhi']; ?>" class="form-control" required/></div>
	</div><br/>  
	
		<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:red">日志群Chat_id设置</label>
	  <div class="col-sm-10"><input type="text" name="rizhichatid" value="<?php echo $conf['rizhichatid']; ?>" class="form-control" required/></div>
	</div><br/>  
	
		<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:blue">同一个ip，120分钟内不能提交超过多少次补单</label>
	  <div class="col-sm-10"><input type="text" name="iptijiao" value="<?php echo $conf['iptijiao']; ?>" class="form-control" required/></div>
	</div><br/>  
	
		<div class="form-group">
	  <label class="col-sm-2 control-label" style="color:green">同一个ip，120分钟内不能提交超过多少次补单查询</label>
	  <div class="col-sm-10"><input type="text" name="ipchadan" value="<?php echo $conf['ipchadan']; ?>" class="form-control" required/></div>
	</div><br/>  
	
		<div class="form-group">
	  <label class="col-sm-2 control-label" style="">补单机器人token</label>
	  <div class="col-sm-10"><input type="text" name="budantoken" value="<?php echo $conf['budantoken']; ?>" class="form-control" required/></div>
	</div><br/>  
	<div class="form-group">
	  <label class="col-sm-2 control-label" style="">天使机器人token</label>
	  <div class="col-sm-10"><input type="text" name="tianshijiqiren" value="<?php echo $conf['tianshijiqiren']; ?>" class="form-control" required/></div>
	</div><br/>  
