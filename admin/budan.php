...
<form onsubmit="return searchSettle()" method="GET" class="form-inline">
  <div class="form-group">
    <label>搜索</label>
	<select name="column" class="form-control"><option value="uid">商户号</option><option value="account">订单号</option><option value="username">姓名</option></select>
  </div>
  <div class="form-group">
  ...
  <a href="javascript:listTable('start')" class="btn btn-default" title="刷新补单列表"><i class="fa fa-refresh"></i></a>
</form>
...
function setStatusDo(id, status) {
	...
	$.ajax({
		type : 'get',
		url : 'ajax.php',
		data : 'act=setBudanStatus&id=' + id + '&status=' + status,
		dataType : 'json',
