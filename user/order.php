...
<?php }?>
	<div class="panel panel-default">
		...
		<center><h5><font color="#FF0000">温馨提示：如果本平台有订单并显示 已支付 通知失败，请不必慌张只是系统异步通知失败，而不是漏单！</font></h5></center>
<center><h5><font color="blue">温馨提示：如果本平台有订单并显示已完成，而代刷网后台没有该订单，就证明漏单了，请搜索找到漏掉的该订单，然后点击订单后面的补单即可！</font></h5></center>
