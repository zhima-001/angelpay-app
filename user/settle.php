...
<div class="alert alert-info"><a class="btn btn-sm btn-danger">温馨提示:结算请联系Telegram客服</a>
</div>
...
?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <center>
            <div class="list-group">
              <div class="list-group-item list-group-item-info">如果有任何问题请联系我们的客服</strong></div>
			<div class="modal-body">
				
<p class="bg-primary" style="background-color:#00D522;padding: 3px;">
<img border="0" width="32" src="http://vs.qqzzz.net/images/new.gif"><font color=blue>待结算</font>说明资金等待银行出款。
</p>

<p class="bg-primary" style="background-color:#00D5FF;padding: 3px;">
<img border="0" width="32" src="http://vs.qqzzz.net/images/new.gif"><font color=orange>正在结算</font>说明资金正在排队结算中，很快就要打款到账。
</p>
   <p class="bg-primary" style="background-color:#DFA5A4;padding: 3px;">
<img border="0" width="32" src="http://vs.qqzzz.net/images/new.gif">
<font color=green>已经到账</font>说明资金已经到您的结算账户上了哦！请您注意查收！
</p>            
