...
<marquee scrollamount="5" direction="left" align="Middle" style="font-weight: bold;line-height: 20px;font-size: 20px;color: #FF0000;">
  欢迎回来 ^_^
  <div class="btn btn-success btn-sm">
    <?php echo $userrow['username']?></div>
  当前时间:
...
?>
		...
		<div class="panel b-a">
            <div class="panel-heading bg-info dk no-border wrapper-lg">
              <a class="btn btn-sm btn-rounded btn-danger pull-right m-r" href="./editinfo.php"><i class="fa fa-cog fa-fw"></i>&nbsp;修改资料</a>
              <a class="btn btn-sm btn-rounded btn-danger m-l" href="./userinfo.php?mod=api"><i class="fa fa-lock fa-fw"></i>&nbsp;API信息</a>
            </div>
            <div class="text-center m-b clearfix">
             ...
             <div class="list-group-item reed">
              <marquee scrollamount="8" direction="left" align="Middle" style="font-weight: bold;line-height: 20px;font-size: 20px;color: #337ab7;">
                <font color="#ff0000"><img border="0" width="32">【名言警句】</font>天行健，君子以自强不息，地势坤，君子以厚德载物。
              </marquee>
            </div>
            <div class="hbox text-center b-t b-light bg-light">          
              <a class="col padder-v text-muted b-r b-light">
                <div class="h3"><font color="red"><span id="order_today_all"></span>元</font></div>
                <i class="fa fa-pencil fa-fw"></i><span>今日总共收入</span>
              </a>
              <a class="col padder-v text-muted">
                <div class="h3"><font color="#58bb2d"><span id="order_lastday_all"></span>元</font></div>
                <i class="fa fa-edit fa-fw"></i><span>昨日总共收入</span>
              </a>
            </div>
		...
		<div class="panel-heading font-bold text-center">
		 ...
		 <div class="list-group-item reed">
              <marquee scrollamount="8" direction="left" align="Middle" style="font-weight: bold;line-height: 20px;font-size: 20px;color: #337ab7;">
                <font color="#ff0000"><img border="0" width="32">【系统公告】</font>务必仔细看
              </marquee>
            </div>
...
<div class="panel panel-default">
<div class="list-group">
 <!---div class="list-group-item bg-light mb-sm" style="background: linear-gradient(to right,#14b7ff,#b221ff);"--->
<!---div class="list-group-item bg-info mb-sm"--->
<!---div class="list-group-item bg-light mb-sm" style="background-color:#66CCFF;"--->
<div class="list-group-item bg-info mb-sm"">
<div class="clear">
</div>
基本资料
...
<label class="col-sm-2 control-label">支付接口</label>
<div class="col-sm-9">
<div class="input-group">
<input class="form-control" type="text" value="找客服索要" disabled>
<a class="input-group-addon" id="copy-jk" data-clipboard-text="找客服索要">一键复制</a>
</div>
</div>
</div>
...
<div class="col-sm-9">
<input class="form-control" type="text" value="<?php echo $uid?>" disabled>
</div>
</div>
<div class="line line-dashed b-b line-lg pull-in"></div>
<div class="form-group">
...
<a class="input-group-addon" id="copy-key" data-clipboard-text="<?php echo $userrow['key']?>">一键复制</a>
							</form>
						</div>
          </div>
        </div>
