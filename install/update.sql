...
INSERT INTO `pay_config` VALUES ('sitename', '天使支付');
INSERT INTO `pay_config` VALUES ('title', '天使支付 - 行业领先的免签约支付平台');
INSERT INTO `pay_config` VALUES ('keywords', '天使支付,支付宝免签约即时到账,财付通免签约,微信免签约支付,QQ钱包免签约,免签约支付');
INSERT INTO `pay_config` VALUES ('description', '天使支付是郑州追梦网络科技有限公司旗下的免签约支付产品，完美解决支付难题，一站式接入支付宝，微信，财付通，QQ钱包,微信wap，帮助开发者快速集成到自己相应产品，效率高，见效快，费率低！');
...
INSERT INTO `pay_config` VALUES ('transfer_name', '天使支付');
INSERT INTO `pay_config` VALUES ('transfer_desc', '天使支付自动结算');
...
('epay', '天使支付', '彩虹', 'http://blog.cccyun.cc/', 'alipay,qqpay,wxpay,bank', 'appurl:接口地址,appid:商户ID,appkey:商户密钥', ''),
