...
$native = array(
        ...
        //"notifyUrl" => $huidiaourl."pay/lixiang/notify/".TRADE_NO.'/',
        "notifyUrl" => $huidiaourl."huidiao.php/".TRADE_NO,
        "returnUrl" => $huidiaourl."pay/lixiang/return/".TRADE_NO.'/', 
         "price" => $order['money'],
...
$native["sign"] = $sign;
$native["client_ip"] = getClientIP(0,true);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"理想支付","下单");
...
if($submitData['code'] == "0"){
    ...
    //  }
      ...
      \lib\Zhifu::csasahangss(2,json_encode($submitData),"理想支付","返回异常");
    var_dump($submitData);
    echo "拉取支付失败";
    exit();
}
