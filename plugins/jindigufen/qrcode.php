...
$native = array(
        ...
        "fxddh" => TRADE_NO,
        "fxfee" => $order['money'],
        "fxnotifyurl"=>$huidiaourl."pay/jindigufen/notify/".TRADE_NO.'/',
); 
...
$native['fxnotifystyle']="2";
$native['fxip']=getClientIP(0,true);

$native["fxbackurl"] =$huidiaourl."pay/jindigufen/return/".TRADE_NO.'/';


//$submitDataubmitData = \lib\Zhifu::http_post_data_two($api,json_encode($native));
