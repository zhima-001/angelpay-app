...
$native = array(
        ...
        "returnUrl" => $huidiaourl."pay/dahuazhineng/return/".TRADE_NO.'/', 
         "amount" => $order['money']*100,
         "subject"=>"vip",
         "extra"=>"VIP",
         "clientIp"=>getClientIP(0,true),
         'body'=>getUnixTimestamp(),
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"达华智能支付","下单");
...
if($submitData['retCode'] == "SUCCESS"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"达华智能支付","返回异常");
