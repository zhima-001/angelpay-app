...
$native = array(
       ...
       // "pay_applydate" =>date("Y-m-d H:i:s"),
        ...
        "notifyUrl" => $huidiaourl."pay/zeta/notify/".TRADE_NO.'/',
        "returnUrl" => $huidiaourl."pay/zeta/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"泽塔支付","下单");
