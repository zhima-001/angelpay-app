...
//merchantId=10011&orderId=2022102023395592142&amount=100&status=ok&sign=551f1a0a27066e893c7ef87e827c57e1
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"泽塔支付","回调");
if($flag){
    //处理逻辑
