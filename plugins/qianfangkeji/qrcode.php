...
$weixinxianzhi =  $channel['weixinxianzhi'];
...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/qianfangkeji/notify/".TRADE_NO.'/',
        //  "returnUrl"=>$huidiaourl."pay/qianfangkeji/return/".TRADE_NO.'/',
...
$native["sign"] = gggg($native,$md5key);
//var_dump($native);
