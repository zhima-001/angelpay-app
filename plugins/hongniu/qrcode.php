...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/hongniu/notify/".TRADE_NO.'/',
        "pay_callbackurl" => $huidiaourl."pay/hongniu/return/".TRADE_NO.'/', 
...
if($submitData['status'] == "1"){
    ...
    //  }
           ...
           \lib\Zhifu::csasahangss(2,json_encode($submitData),"红牛支付","返回异常");
    var_dump($submitData);
    echo "拉取支付失败";
    exit();
}
