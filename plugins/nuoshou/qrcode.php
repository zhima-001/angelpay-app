...
//请求地址
$api = "http://45.114.93.227/api/createOrder";

$native = array(
    "merchantid" => $merId,
    "merchantorderid" => TRADE_NO,
    "applyamount" => $order['money'],
    "timestamp" =>getUnixTimestamp(),
    "orderchannel" => $channel['appurl'],
    "callbackurl" => "http://huitiao.freewing123.xyz/pay/nuoshou/notify/".TRADE_NO.'/',
);
ksort($native);
$md5str = "";
