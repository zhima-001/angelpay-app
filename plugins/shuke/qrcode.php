...
//请求地址
$fxgetway = "http://137.220.133.225:8888/api/unifiedorder";
$fxkey = $md5key;
...
$data = array(
   ...
   // "body" => 'mytest', //附加信息
        "notify_url" =>  "http://huitiao.freewing123.xyz/pay/shuke/notify/".TRADE_NO.'/', //异步回调 , 支付结果以异步为准
        "return_url" =>  "http://huitiao.freewing123.xyz/pay/shuke/return/".TRADE_NO.'/', //同步回调 不作为最终支付结果为准，请以异步回调为准
       "pass_code" => $channel['appurl'], //支付类型 此处可选项以网站对接文档为准 微信公众号：wxgzh   微信H5网页：wxwap  微信扫码：wxsm   支付宝H5网页：zfbwap  支付宝扫码：zfbsm 等参考API
        "client_ip" => getClientIPs(0, true), //支付端ip地址
...
$submitData = \lib\Zhifu::http_post_data2($fxgetway,json_encode($data));
