...
$returnArray = array( // 返回字段
 "status" =>  $_REQUEST["status"], // 流水号
     "msg"=>$_REQUEST['msg'],
    "tenantOrderNo" => $_REQUEST["tenantOrderNo"], // 商户ID
     "oldAmount" =>  $_REQUEST["oldAmount"], // 交易时间
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"徐家汇支付","回调");
if($flag){
    //处理逻辑
    $out_trade_no  = $_REQUEST['tenantOrderNo'];
