...
function sendPostRequest($url, $data)
{
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, [
        "Content-Type: application/x-www-form-urlencoded", // Postman 使用的默认 Content-Type
    ]);
...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/manbuzhe/notify/".TRADE_NO.'/',
        "pay_callbackurl"=>$huidiaourl."pay/manbuzhe/return/".TRADE_NO.'/',
...
$native['pay_ip']=getClientIP(0,true);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"漫步者支付","下单");
