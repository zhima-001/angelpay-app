...
//merchantId=10060&orderId=2022103014512325574&amount=100&status=ok&sign=3391dadc0923a6a3d346fe3c7cf10ddc
...
$sign =getSign($returnArray, $md5key);
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"埃安支付","回调");
if($flag){
    //处理逻辑
