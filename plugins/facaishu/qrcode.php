...
//请求地址
$api = "http://api.a8a8.me:1818/go/gateway.go";

$native = array(
    "pid" => $merId,
    'cid'=>$channel['appurl'],
    'type'=>$order['terminals'],
    'oid'=>TRADE_NO,
    'uid'=>"123",
    "amount" => $order['money']*100,
    "burl" => "http://huitiao.freewing123.xyz/pay/facaishu/notify/".TRADE_NO.'/',
    "nurl" => "http://huitiao.freewing123.xyz/pay/facaishu/notify/".TRADE_NO.'/',
    'eparam'=>"123",
