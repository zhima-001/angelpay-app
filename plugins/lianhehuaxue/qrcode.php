...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/lianhehuaxue/notify/".TRADE_NO.'/',
         "pageUrl"=>$huidiaourl."pay/lianhehuaxue/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"联合化学支付","下单");
