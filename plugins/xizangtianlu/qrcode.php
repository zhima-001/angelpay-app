...
$native = array(
        ...
        "app_id"=>$merId,
        "order_no" => TRADE_NO, 
        "submit_amount" => $order['money'],
        "notify_url" => $huidiaourl."huidiao.php/".TRADE_NO,
        //"notify_url" => $huidiaourl."pay/xizangtianlu/notify/".TRADE_NO.'/',
        "return_url"=>$huidiaourl."pay/xizangtianlu/return/".TRADE_NO.'/',
        "time"=>time(),
...
$sign = strtolower(md5(strtoupper($md5str  ."key=". $md5key))); 
$native['sign']=$sign;
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"西藏天路支付","下单");
