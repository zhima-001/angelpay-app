...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/yuanli/notify/".TRADE_NO.'/',
        "returnUrl" => $huidiaourl."pay/yuanli/return/".TRADE_NO.'/', 
         "amount" => $order['money'],
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"元利支付","下单");
...
if($submitData['retCode'] == "SUCCESS"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"元利支付","异常通知");
