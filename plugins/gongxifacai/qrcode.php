...
$native = array(
    ...
    "pay_notifyurl" => $huidiaourl."pay/gongxifacai/notify/".TRADE_NO.'/',
    "pay_callbackurl" => $huidiaourl."pay/gongxifacai/return/".TRADE_NO.'/', 
);  
ksort($native);
$md5str = "";
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"恭喜发财支付","下单");
