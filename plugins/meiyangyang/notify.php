...
//md5(订单状态+商务号+商户订单号+支付金额+商户秘钥)
        ...
        $returnArray = array( // 返回字段
          ...
          "original_trade_no" =>  $_REQUEST["original_trade_no"], // 交易金额
            "money" =>  $_REQUEST["money"], // 交易金额
            "notify_time" =>  $_REQUEST["notify_time"], // 交易金额
          "subject" =>  $_REQUEST["subject"], // 交易金额
          //"body" =>  $_REQUEST["body"], // 交易金额
...
if($flag){
	...
	$orderAmt = $Money;
	$trade_no = daddslashes($returnArray["trade_no"]);
