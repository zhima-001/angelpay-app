...
$native = array(
        ...
        "pay_product_id" => $channel['appurl'],
        "notify_url" => $huidiaourl."pay/zhongguoliantong/notify/".TRADE_NO.'/', //$huidiaourl."huidiao.php/".TRADE_NO,
        "callback_url" => $huidiaourl."pay/zhongguoliantong/return/".TRADE_NO.'/', 
...
$sign = strtoupper(md5(md5($md5str . "key=" . $md5key) . $md5key));
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),$pay_title,"下单");
...
if($tg_beizhu == "Tg"){
    ...
    if($submitData['code'] == "1"){
        ...
        $arr = array(
           ...
           'pay_url' => $submitData['data']['pay_url'],
           'type' => "0",
           "money"=>$order['money'],
...
if($submitData['code'] == "1"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),$pay_title,"返回异常");
