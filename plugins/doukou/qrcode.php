...
$api = $channel['apiurl'];//http://xysc.info:56700/api/pay/create_order
...
"subject"=>"svip",
    "notifyUrl" =>$huidiaourl."pay/doukou/notify/".TRADE_NO.'/',
    "returnurl"=>$huidiaourl."pay/doukou/return/".TRADE_NO.'/',
   "reqTime" => date("YmdHis"),
   "version"=>"1.0",
   'body'=>"123",
