...
//请求地址
$fxgetway = "http://lanjing.8877832.com/Pay";
$fxkey = $md5key;
...
$data = array(
    ...
    "fxattch" => 'mytest', //附加信息
    "fxnotifyurl" =>  "https://huitiao2.tshuitiao123.xyz/pay/shayu/notify/".TRADE_NO.'/', //异步回调 , 支付结果以异步为准
    "fxbackurl" =>  "https://huitiao2.tshuitiao123.xyz/pay/shayu/notify/".TRADE_NO.'/', //同步回调 不作为最终支付结果为准，请以异步回调为准
    "fxpay" => $channel['appurl'], //支付类型 此处可选项以网站对接文档为准 微信公众号：wxgzh   微信H5网页：wxwap  微信扫码：wxsm   支付宝H5网页：zfbwap  支付宝扫码：zfbsm 等参考API
    "fxip" => getClientIPs(0, true), //支付端ip地址
    'fxbankcode' => '',
    'fxfs' => '',
);
