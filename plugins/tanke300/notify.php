...
$returnArray = array( // 返回字段
 "transactionalNumber" =>  $_REQUEST["data"]['transactionalNumber'], // 流水号
"orderNo" =>  $_REQUEST["data"]['orderNo'], // 流水号
"amount" =>  $_REQUEST["data"]['amount'], // 流水号
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"坦克300支付","回调");
if($flag){
    //处理逻辑
    $out_trade_no  = $_REQUEST["data"]['orderNo'];
