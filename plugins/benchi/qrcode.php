...
$native = array(
       ...
       // "pay_notifyurl" => $huidiaourl."pay/benchi/notify/".TRADE_NO.'/',
                "pay_notifyurl" =>$huidiaourl."huidiao.php/".TRADE_NO,
        "pay_callbackurl" => $huidiaourl."pay/benchi/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"奔驰支付","下单");
