...
$returnArray = array( // 返回字段
 "pay_time" =>  $_REQUEST["pay_time"], // 流水号
     "money"=>$_REQUEST['money'],
    "pay_money" => $_REQUEST["pay_money"], // 商户ID
     "order_sn" =>  $_REQUEST["order_sn"], // 交易时间
     "pay_state"=>$_REQUEST['pay_state'],
       "sys_order_sn"=>$_REQUEST['sys_order_sn'],
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"芝麻支付","回调");
if($flag){
    //处理逻辑
