...
$native = array(
        ...
        "notify_url" => $huidiaourl."pay/zhima/notify/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"芝麻支付","下单");

//type : 0=使用商户链接  1=PC页面  2=使用PC页面的短码

if($tg_beizhu == "Tg"){
    
    if($submitData['code'] == "100"){
...
if($submitData['code'] == "100"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"芝麻支付","异常通知");
