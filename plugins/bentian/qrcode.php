...
$native = array(
        ...
        //"pay_notifyurl" => $huidiaourl."pay/bentian/notify/".TRADE_NO.'/',
        "pay_notifyurl" => $huidiaourl."huidiao.php/".TRADE_NO,
        "pay_callbackurl" => $huidiaourl."pay/bentian/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"本田支付","下单");
