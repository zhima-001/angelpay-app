...
$native = array(
    ...
    "pay_notifyurl" =>  $huidiaourl."pay/sanyangma/notify/".TRADE_NO.'/',
    "pay_callbackurl" => $huidiaourl."pay/sanyangma/return/".TRADE_NO.'/',
);
ksort($native);
$md5str = "";
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"三羊马支付","下单");
