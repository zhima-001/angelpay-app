...
$native = array(
   ...
   "pay_type" => $channel['appurl'],
    ...
    "notify_url" => urlencode($huidiaourl."pay/jiumuwang/notify/".TRADE_NO.'/'),
    'timestamp'=>time(),
    'mch_secret'=>$md5key
);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"九牧王支付","下单");
$now_time2= time();
...
if($submitData['status']){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"九牧王支付","异常通知");
