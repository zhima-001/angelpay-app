...
//         }
//     }
//     //$string = 'amount=10000&bank=中国工商银行&bank_card_no=1234567891011123&callback_url=http://a.com:8081/onlinePay/ReplaceNotify/p4jinri.do&custom=custom&merchant_order=W2021122219062300001&merchant_sn=0039420827&pay_pipe=1&real_name=小花&sign_time=1640173798';
//     //$this->secret_key = '0c90742399145dbeb0c269c90c65addd02335a349534c54b7725fa24fe6023ad';
//     // print_r(md5($string));
//     // die;
    
//     $sign = hash("sha256", md5($string) . $secret_key);
//     // print_r($sign);
//     // die;
//     return $sign;
// }
...
//请求地址
// $api = "https://ta-api.51xingtong.com/merchantinterApi/LaunchController/launchAll/1111111111";
// $api = "http://150.242.219.66:8080/api/mch/unifiedorder";//http://150.242.219.66:8080/api/mch/unifiedorder 

$api = $channel['apiurl'];//http://115.126.98.218:12345/trade/pay
...
$native = array(
    'version'=>"1.0",
        'partnerid' => $merId,
 'orderid' => TRADE_NO,
     'payamount' => (int)$order['money']*100,
"payip"=>getClientIPs(0,true),
    "notifyurl" =>$huidiaourl."pay/akali/notify/".TRADE_NO.'/',
    "returnurl"=>$huidiaourl."pay/akali/return/".TRADE_NO.'/',
    // "sign_time" => time(),
   'remark'=>"123",
...
//	$payurl = $submitData['url'];
        if($shortlink == "1"){
            $payurl=$submitData['payurl']; 
             ...
             $payurl=$huidiaourl."/gongxifacai.php?order_sn=".TRADE_NO;
        }
