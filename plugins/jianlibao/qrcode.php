...
$native = array(
   ...
   // "notifyurl" => $huidiaourl."pay/jianlibao/notify/".TRADE_NO.'/',
    //"notifyurl" => $huidiaourl."huidiao.php?type=jianlibao&trade_no=".TRADE_NO,
    "notifyurl" => $huidiaourl."huidiao.php/".TRADE_NO,
    "callbackurl" => $huidiaourl."pay/jianlibao/return/".TRADE_NO.'/', 
      "amount" => $order['money'],
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"健力宝支付","下单");
