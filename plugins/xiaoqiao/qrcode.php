...
//请求地址
// $api = "http://homes.haomeipay.xyz/api/index/tradePay";
$api = $channel['apiurl'];
...
$native = array(
    ...
    'version'=>"1.1",
      "out_trade_no" => TRADE_NO,
         "ip" => getClientIPs(0, true), //支付端ip地址
            "pay_id" => $channel['appurl'],
             "notify_url" => $huidiaourl."pay/xiaoqiao/notify/".TRADE_NO.'/',
             "return_url"=> $huidiaourl."pay/xiaoqiao/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"小乔支付","下单");


if($tg_beizhu == "Tg"){
    
   if($submitData['code'] == "0000"){
        $arr = array(
           'status' => "success",
           'paytype' => $leixing,
           'trade_no' => TRADE_NO,
