...
$returnArray = array( // 返回字段
    "merch" =>  $_REQUEST["merch"], // 流水号
    "uid"=>$_REQUEST['uid'],
    "orderNo" => $_REQUEST["orderNo"], // 商户ID
    "statePayd" =>  $_REQUEST["statePayd"], // 交易时间
    "amount"=>$_REQUEST['amount'],
    "amountReal"=>$_REQUEST['amountReal'],
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"奇妙蒙克支付","回调");
if($flag){
    //处理逻辑
