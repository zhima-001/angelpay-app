...
$native = array(
     "amount" => $order['money'],
        "ext1" => $huidiaourl."pay/xiaozhu/notify/".TRADE_NO.'/',
             "ext2" =>getClientIPs(0,true),
              "ext3" => $huidiaourl."pay/xiaozhu/return/".TRADE_NO.'/',
