...
$native = array(
        ...
        "callBackUrl" => $huidiaourl."pay/lioukeji/notify/".TRADE_NO.'/',
        "returnUrl"=>$huidiaourl."pay/lioukeji/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"利欧科技支付","下单");
