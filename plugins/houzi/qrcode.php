...
$native = array(
    ...
    //"pay_notifyurl" => $huidiaourl."pay/houzi/notify/".TRADE_NO.'/',
    "pay_notifyurl" => $huidiaourl."huidiao.php/".TRADE_NO,
    "pay_callbackurl" => $huidiaourl."pay/houzic/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"猴子支付","下单");
