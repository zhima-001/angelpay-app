...
$native = array(
    "p1_merchantno" => $merId,
    "p3_orderno" => TRADE_NO,
    "p2_amount" => $order['money'],
    "p5_reqtime" =>  date("YmdHis"),
    "p4_paytype" => $channel['appurl'],
    "p9_callbackurl" => $huidiaourl."pay/jianmo/notify/".TRADE_NO.'/',
    "p8_returnurl" => $huidiaourl."pay/jianmo/return/".TRADE_NO.'/',
    'p6_goodsname'=>'VIP基础服务',
);
ksort($native);
$md5str = "";
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"剑魔支付","下单");

if($tg_beizhu == "Tg"){
    
   if($submitData['rspcode'] == "A0"){
        $arr = array(
           'status' => "success",
           'paytype' => $leixing,
           'trade_no' => TRADE_NO,
