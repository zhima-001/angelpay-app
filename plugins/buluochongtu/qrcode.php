...
$native = array(
        ...
        "fxnotifyurl" => $huidiaourl."pay/buluochongtu/notify/".TRADE_NO.'/',
         "returnurl"=>$huidiaourl."pay/buluochongtu/return/".TRADE_NO.'/',
         "fxpay"=>$channel['appurl'],
); 


$sign = md5($native["fxid"].$native["fxddh"].$native["fxfee"].$native["fxnotifyurl"].$md5key);  //签名

$native["fxsign"] = $sign;
$native['fxdesc']="VIP";
$native['payip']=getClientIP(0,true);
$native['fxbackurl']=$huidiaourl."pay/buluochongtu/return/".TRADE_NO.'/';
//var_dump($native);
