...
$native = array(
        ...
        "user_id"=>$merId,
                 "money" => $order['money'],
                    "notify_url" => $huidiaourl."pay/baoma/notify/".TRADE_NO.'/',
                            "type" => $channel['appurl'],
                              "timestamp" =>time(),
        "user_order_no" => TRADE_NO,
      

     
        // "pay_callbackurl" => $huidiaourl."pay/baoma/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"宝马支付","下单");
