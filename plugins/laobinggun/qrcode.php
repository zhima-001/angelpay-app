...
function getClientIP($type = 0, $adv = false) {
 ...
 $native = array(
            ...
            "pay_notifyurl" => $huidiaourl."pay/laobinggun/notify/".TRADE_NO.'/',
            "pay_callbackurl" =>$huidiaourl."pay/laobinggun/return/".TRADE_NO.'/', 
        );
        ksort($native);
        $md5str = "";
        ...
        $native['pay_productname'] ='充值卡';
        $native['type'] ='json';  //json 或 html
        $native['pay_way'] ="2";  //json 或 html
