...
$flag = false;
$data = [];
$data['mchid'] = $_POST['mchid'];//商户号
$data['out_trade_no']   = $_POST['out_trade_no'];//第三方订单号
$data['total_fee']    = $_POST['total_fee'];//金额，元单位
$data['trade_no']   = $_POST['trade_no'];//平台订单号

$sign = getSign($data, $md5key);
$keysign = $_POST['sign'];
...
if($flag){
	...
	$orderAmt = $Money;
	$trade_no = daddslashes($data["total_fee"]);
