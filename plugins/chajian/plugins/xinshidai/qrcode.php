...
$native = array(
    ...
    "pay_notifyurl" => "http://huitiao.freewing123.xyz/pay/xinshidai/notify/".TRADE_NO.'/',
    "pay_callbackurl" => "http://huitiao.freewing123.xyz/pay/xinshidai/return/".TRADE_NO.'/', 
);
ksort($native);
$md5str = "";
...
$api="http://103.60.108.196:23333/Pay_Index.html";
...
if($new_submitData['retCode'] =="SUCCESS"){
   ...
   // $resp2 = Http::get($new_submitData['data']['pay_url']);
    ...
    echo "<script>";
    echo "window.location.href='" . $new_submitData['payParams']['payUrl']. "'";
    echo ";</script>";
    exit;
    //echo $submitData;
