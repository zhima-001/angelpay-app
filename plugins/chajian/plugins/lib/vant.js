    ...
    return function (t) {
        ...
        a(o, "$vantLang", "zh-CN"), a(o, "$vantMessages", {
            "zh-CN": {
                ...
                telEmpty: "璇峰～鍐欑數璇�",
                nameEmpty: "璇峰～鍐欏鍚�",
                nameInvalid: "璇疯緭鍏ユ纭殑濮撳悕",
                confirmDelete: "纭畾瑕佸垹闄ゅ悧",
                telInvalid: "璇疯緭鍏ユ纭殑鎵嬫満鍙�",
                vanCalendar: {
                    end: "缁撴潫",
                    start: "寮€濮�",
                    title: "鏃ユ湡閫夋嫨",
        ...
        function o(t) {
            if (Object(s.b)(t)) return t = String(t), Object(r.b)(t) ? t + "px" : t
        }
        ...
        function l(t) {
            return "number" == typeof t ? t : -1 !== t.indexOf("rem") ? a(t) : parseFloat(t)
        }
    }, function (t, e, i) {
        "use strict";
        i.d(e, "a", (function () {
        ...
        function u(t) {
            return function (e) {
                return Object(s.c)(e) && (e = c(e)), e.functional || (e.mixins = e.mixins || [], e.mixins.push(a)), e.name = t, e.install = l, e
            }
        }
        var h = i(6);
        ...
        function d(t) {
            var e = Object(r.a)(t) + ".";
            return function (t) {
                for (var i = h.a.messages(), n = Object(s.a)(i, e + t) || Object(s.a)(i, t), r = arguments.length, o = new Array(r > 1 ? r - 1 : 0), a = 1; a < r; a++) o[a - 1] = arguments[a];
        ...
        function b(t, e, i, n) {
            void 0 === n && (n = !1), m.f || t.addEventListener(e, i, !!v && {
                capture: !1,
                passive: n
            })
        }
        ...
        function T(t, e, i, s) {
            ...
            return Object(m.b)(e.duration) && (o.animationDuration = e.duration + "s"), t("transition", {
                attrs: {
                    name: "van-fade"
                }
            }, [t("div", r()([{
        ...
        function _(t) {
            function e() {
                this.binded || (t.call(this, b, !0), this.binded = !0)
            }

            function i() {
                this.binded && (t.call(this, y, !1), this.binded = !1)
            }
            return {
                mounted: e,
                activated: e,
        ...
        function Y(t) {
            return void 0 === t && (t = {}), {
                ...
                beforeDestroy: function () {
                    var t, e;
                    this.removeLock(), t = this, (e = p.find(t)) && B(e.overlay.$el), this.getContainer && B(this.$el)
                },
                ...
                methods: {
                    ...
                    removeLock: function () {
                        this.lockScroll && (p.lockCount--, y(document, "touchstart", this.touchStart), y(document, "touchmove", this.onTouchMove), p.lockCount || document.body.classList.remove("van-overflow-hidden"))
                    },
                    close: function () {
        ...
        function nt(t, e, i, n) {
            ...
            return t(e.tag, r()([{
                ...
                attrs: {
                    dot: e.dot,
                    info: Object(m.b)(e.badge) ? e.badge : e.info
                }
            })])
        }
        nt.props = {
                ...
                render: function () {
                    ...
                    if (this.shouldRender) {
                        ...
                        return e("transition", {
                            ...
                            class: at("close-icon", this.closeIconPosition),
                            on: {
                                click: this.close
                            }
                        })])])
        ...
        function ft(t, e, i) {
            if (i.default) {
                var n = e.textSize && {
                    fontSize: Object(U.a)(e.textSize)
                };
                return t("span", {
                    class: ht("text"),
                    style: n
        ...
        function yt(t, e, i, n) {
            ...
            return t(lt, r()([{
                ...
                return t("button", {
                    ...
                    on: {
                        click: function (t) {
                            t.stopPropagation(), r || o || (a && a(i), d(n, "select", i, s), e.closeOnClickAction && d(n, "input", !1))
                        }
                    }
                }, [o ? t(mt, {
                    attrs: {
        ...
        function At(t) {
            return Object(m.d)(t) && t.disabled
        }
        var zt = Lt({
                mixins: [R],
                props: {
                ...
                methods: {
                    ...
                    onTouchMove: function (t) {
                        this.touchMove(t), "vertical" === this.direction && (this.moving = !0, k(t, !0)), this.offset = jt(this.startOffset + this.deltaY, -this.count * this.itemHeight, this.itemHeight);
                        var e = Date.now();
                    ...
                    getOptionText: function (t) {
                        return Object(m.d)(t) && this.valueKey in t ? t[this.valueKey] : t
                    },
                    ...
                    genOptions: function () {
                        var t = this,
                            ...
                            i = {};
                        return 44 !== this.itemHeight && (i.height = this.itemHeight + "px"), this.options.map((function (n, s) {
            ...
            Ht = Ft({
                ...
                computed: {
                    itemPxHeight: function () {
                        return this.itemHeight ? Object(U.b)(this.itemHeight) : 44
                    },
                    dataType: function () {
                ...
                methods: {
                    ...
                    formatCascade: function () {
                        for (var t = this, e = [], i = {
                            ...
                            var n = Object(m.b)(i.defaultIndex) ? i.defaultIndex : +this.defaultIndex;
                            e.push({
                    ...
                    setColumnValues: function (t, e) {
                        ...
                        n && ("cascade" === this.dataType ? n.setOptions(e.map((function (t) {
                            return Object(m.d)(t) ? t[i.valueKey] : t
                        }))) : n.setOptions(e))
                    },
                    getValues: function () {
                    ...
                    genToolbar: function () {
                        ...
                        }, [this.cancelButtonText || Rt("cancel")]), this.genTitle(), t("button", {
                            attrs: {
                                type: "button"
                            },
                            class: Vt("confirm"),
                        ...
                        }, [this.confirmButtonText || Rt("confirm")])]])
                    },
                    genColumns: function () {
                        var t = this.$createElement,
                            e = this.itemPxHeight,
                ...
                render: function (t) {
                    return t("div", {
                        class: Vt()
                    }, ["top" === this.toolbarPosition ? this.genToolbar() : t(), this.loading ? t(mt, {
                        class: Vt("loading")
        ...
        var Kt = !m.f && /ios|iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase());
        ...
        function ne(t, e, i, n) {
            var s = e.icon,
                ...
                c = e.value,
                u = e.isLink,
                f = i.title || Object(m.b)(a);

            function p() {
                if (i.label || Object(m.b)(l)) return t("div", {
            ...
            return o && (g[o] = o), t("div", r()([{
                ...
                if (i.default || Object(m.b)(c)) return t("div", {
                    class: [ie("value", {
                        alone: !f
                    }), e.valueClass]
        ...
        var se = ee(ne),
            ...
            le = oe({
                ...
                computed: {
                    showClear: function () {
                        return this.clearable && this.focused && "" !== this.value && Object(m.b)(this.value) && !this.readonly
                    },
                    showError: function () {
                ...
                methods: {
                    ...
                    runValidator: function (t, e) {
                        return new Promise((function (i) {
                            ...
                            if (Object(m.e)(n)) return n.then(i);
                            i(n)
                        }))
                    },
                    ...
                    resetValidation: function () {
                        this.validateMessage && (this.validateFailed = !1, this.validateMessage = "")
                    },
                    updateValue: function (t, e) {
                        void 0 === e && (e = "onChange"), t = Object(m.b)(t) ? String(t) : "";
                        var i = this.maxlength;
                        (Object(m.b)(i) && t.length > i && (t = t.slice(0, i)), "number" === this.type || "digit" === this.type) && (t = Dt(t, "number" === this.type));
                        this.formatter && e === this.formatTrigger && (t = this.formatter(t));
                        var n = this.$refs.input;
                        n && t !== n.value && (n.value = t), t !== this.value && this.$emit("input", t), this.currentValue = t
                    },
                    onInput: function (t) {
                    ...
                    onBlur: function (t) {
                        this.focused = !1, this.updateValue(this.value, "onBlur"), this.$emit("blur", t), this.validateWithTrigger("onBlur"), Xt()
                    },
                    onClick: function (t) {
                        this.$emit("click", t)
                    },
                    ...
                    getProp: function (t) {
                        return Object(m.b)(this[t]) ? this[t] : this.vanForm && Object(m.b)(this.vanForm[t]) ? this.vanForm[t] : void 0
                    },
                    genLabel: function () {
                        var t = this.$createElement,
                ...
                render: function () {
                    ...
                    return o && (s.extra = function () {
                        ...
                        attrs: {
                            ...
                            valueClass: ae("value"),
                            titleClass: [ae("label", n), this.labelClass],
                ...
                methods: {
                    ...
                    genMessage: function () {
                        var t = this.$createElement,
                            e = this.type,
                            i = this.message;
                        if (Object(m.b)(i) && "" !== i) return "html" === e ? t("div", {
                            class: de("text"),
                            domProps: {
                                innerHTML: i
                            }
        ...
        function Se(t) {
            ...
            return e.value && e.updateZIndex(), t = ye(t), (t = n(n(n({}, be), me[t.type || be.type]), t)).clear = function () {
                e.value = !1, t.onClose && t.onClose(), ge && !m.f && e.$on("closed", (function () {
            ...
            De = Ie({
                ...
                methods: {
                    ...
                    genButtons: function () {
                        ...
                        return i("div", {
                            ...
                            class: [je("confirm"), (t = {}, t["van-hairline--left"] = n, t)],
                            style: {
                ...
                render: function () {
                    ...
                    if (this.shouldRender) {
                        ...
                        }, [s, this.genContent(n, i), this.genButtons()])])
                    }
                }
            });

        function Ne(t) {
            return m.f ? Promise.resolve() : new Promise((function (e, i) {
                var s;
                Te && (s = Te.$el, document.body.contains(s)) || (Te && Te.$destroy(), (Te = new(l.a.extend(De))({
                    el: document.createElement("div"),
                    propsData: {
                        lazyRender: !1
                    }
        ...
        }, Ne.resetDefaultOptions(), Ne.install = function () {
            l.a.use(De)
        }, Ne.Component = De, l.a.prototype.$dialog = Ne;
        var Le = Ne,
            Pe = Object(o.a)("address-edit-detail"),
            Ae = Pe[0],
            ze = Pe[1],
            Me = Pe[2],
            Fe = !m.f && /android/.test(navigator.userAgent.toLowerCase()),
            Ve = Ae({
                props: {
                    value: String,
                    errorMessage: String,
        ...
        var ni = Je({
            ...
            computed: {
                areaListLoaded: function () {
                    return Object(m.d)(this.areaList) && Object.keys(this.areaList).length
                },
                areaText: function () {
                    var t = this.data,
                        e = t.country,
            ...
            watch: {
                addressInfo: {
                    handler: function (t) {
                        this.data = n(n({}, ii), t), this.setAreaCode(t.areaCode)
                    },
                    deep: !0,
                    immediate: !0
                },
            ...
            methods: {
                ...
                onAreaConfirm: function (t) {
                    (t = t.filter((function (t) {
                        ...
                        return !t.code
                    })) ? ke(ei("areaEmpty")) : (this.showAreaPopup = !1, this.assignAreaValues(), this.$emit("change-area", t))
                },
                ...
                getErrorMessage: function (t) {
                    ...
                    switch (t) {
                        ...
                        case "tel":
                            return this.telValidator(e) ? "" : ei("telInvalid");
                        case "areaCode":
                            return e ? "" : ei("areaEmpty");
                        case "addressDetail":
                            return e ? "" : ei("addressEmpty");
                        case "postalCode":
                            return e && !this.postalValidator(e) ? ei("postalEmpty") : ""
                    }
                },
                onDelete: function () {
                    var t = this;
                    Le.confirm({
                        title: ei("confirmDelete")
                    }).then((function () {
            ...
            render: function () {
                ...
                return e("div", {
                    ...
                    attrs: {
                        ...
                        clickable: !r,
                        label: ei("area"),
                        placeholder: this.areaPlaceholder || ei("areaPlaceholder"),
                    ...
                    attrs: {
                        ...
                        text: this.deleteButtonText || ei("delete")
                    },
                    on: {
                        click: this.onDelete
                    }
        ...
        function pi(t, e, i, n) {
            ...
            return t("transition", {
                ...
                key: "content",
                style: m,
                class: [fi([v, a]), (o = {}, o["van-hairline--surround"] = c, o)]
        ...
        function xi(t, e, i, s) {
            ...
            function l() {
                if (e.data.isDefault && e.defaultTagText) return t(mi, {
                    attrs: {
                        type: "danger",
                        round: !0
                    },
        ...
        function Bi(t, e, i, n) {
            ...
            return t("div", r()([{
                class: Ti()
            }, h(n)]), [null == i.top ? void 0 : i.top(), t(ui, {
                attrs: {
                    value: e.value
                }
            }, [o]), e.disabledText && t("div", {
                class: Ti("disabled-text")
        ...
        function Ei(t) {
            return "[object Date]" === Object.prototype.toString.call(t) && !Object(ji.a)(t.getTime())
        }
        ...
        var _i = (0, Object(o.a)("calendar-month")[0])({
                ...
                computed: {
                    title: function () {
                        return t = this.date, Pi("monthTitle", t.getFullYear(), t.getMonth() + 1);
                        var t
                    },
                    offset: function () {
                ...
                methods: {
                    ...
                    getBottomInfo: function (t) {
                        if ("range" === this.type) {
                            if ("start" === t || "end" === t) return Pi(t);
                            if ("start-end" === t) return Pi("startEnd")
                        }
                    },
                    getDayStyle: function (t, e) {
                        var i = {};
                        return 0 === e && (i.marginLeft = 100 * this.offset / 7 + "%"), 64 !== this.rowHeight && (i.height = this.rowHeight + "px"), this.color && ("start" === t || "end" === t || "start-end" === t || "multiple-selected" === t || "multiple-middle" === t ? i.background = this.color : "middle" === t && (i.color = this.color)), i
                    },
                    genTitle: function () {
                        var t = this.$createElement;
            ...
            Wi = (0, Object(o.a)("calendar-header")[0])({
                props: {
                    title: String,
                    subtitle: String,
                    showTitle: Boolean,
                ...
                methods: {
                    ...
                    scrollIntoView: function () {
                        ...
                        this.$nextTick((function () {
                            ...
                            i && n && t.months.some((function (e, n) {
                                return 0 === Ai(e, i) && (t.$refs.months[n].scrollIntoView(), !0)
                            }))
                        }))
                    },
                    getInitialDate: function () {
                        var t = this.type,
                            ...
                            n = this.defaultDate,
                            s = new Date;
                        if (-1 === zi(s, e) ? s = e : 1 === zi(s, i) && (s = i), "range" === t) {
                            var r = n || [];
                    ...
                    onScroll: function () {
                        ...
                        if (!(n < 0 || s > o && n > 0)) {
                            for (var a, l = 0, c = 0; c < i.length; c++) {
                                var u = l <= s && l + r[c] >= n;
                                u && !a && (a = i[c]), !i[c].visible && u && this.$emit("month-show", {
                                    date: i[c].date,
                                    title: i[c].title
                                }), i[c].visible = u, l += r[c]
                            }
                    ...
                    onClickDay: function (t) {
                        ...
                        if ("range" === i) {
                            ...
                            if (this.currentDate.some((function (t, i) {
                                ...
                                this.$emit("unselect", Vi(l))
                            } else this.maxRange && n.length >= this.maxRange ? ke(this.rangePrompt || Pi("rangePrompt", this.maxRange)) : this.select([].concat(n, [e]))
                    ...
                    select: function (t, e) {
                        var i = this,
                            n = function (t) {
                                i.currentDate = t, i.$emit("select", Ri(i.currentDate))
                            };
                        if (e && "range" === this.type && !this.checkRange(t)) return void(this.showConfirm ? n([t[0], Mi(t[0], this.maxRange - 1)]) : n(t));
                    ...
                    checkRange: function (t) {
                        ...
                        }(t) > e) || (ke(i || Pi("rangePrompt", e)), !1)
                    },
                    onConfirm: function () {
                        this.$emit("confirm", Ri(this.currentDate))
                    },
            ...
            Xi = Ui({
                ...
                computed: {
                    style: function () {
                        var t = {};
                        return Object(m.b)(this.width) && (t.width = Object(U.a)(this.width)), Object(m.b)(this.height) && (t.height = Object(U.a)(this.height)), Object(m.b)(this.radius) && (t.overflow = "hidden", t.borderRadius = Object(U.a)(this.radius)), t
                    }
                },
                created: function () {
                    var t = this.$Lazyload;
        ...
        function Ji(t, e, i, n) {
            var s, o = e.thumb,
                a = i.num || Object(m.b)(e.num),
                l = i.price || Object(m.b)(e.price),
                c = i["origin-price"] || Object(m.b)(e.originPrice),
                u = a || l || c || i.bottom;
            ...
            return t("div", r()([{
                ...
                if (l) return t("div", {
                    ...
                    class: Zi("price-currency")
                }, [e.currency]), t("span", {
                    class: Zi("price-integer")
                }, [n[0]]), ".", t("span", {
                    class: Zi("price-decimal")
                }, [n[1]])]))]);
                var n
            }(), function () {
                if (c) {
        ...
        var tn = Gi(Ji),
            en = Object(o.a)("cell-group"),
            nn = en[0],
            sn = en[1];

        function rn(t, e, i, n) {
            var s, o = t("div", r()([{
                class: [sn(), (s = {}, s[$t] = e.border, s)]
        ...
        var on = nn(rn),
            ...
            cn = Object(o.a)("checkbox-group"),
            un = cn[0],
            hn = cn[1],
            dn = un({
                mixins: [oi("vanCheckbox"), He],
                props: {
                    max: [Number, String],
                    disabled: Boolean,
                    direction: String,
                ...
                render: function () {
                    var t = arguments[0];
                    return t("div", {
                        class: hn([this.direction])
                    }, [this.slots()])
                }
            }),
            fn = i(4),
            pn = Object(o.a)("circle"),
            mn = pn[0],
            vn = pn[1],
            gn = 0;
        ...
        var yn = mn({
                ...
                beforeCreate: function () {
                    this.uid = "van-circle-gradient-" + gn++
                },
                computed: {
                    style: function () {
                        var t = Object(U.a)(this.size);
                        return {
                            width: t,
                            height: t
                        }
                ...
                watch: {
                    rate: {
                        handler: function (t) {
                            this.startTime = Date.now(), this.startRate = this.value, this.endRate = bn(t), this.increase = this.endRate > this.startRate, this.duration = Math.abs(1e3 * (this.startRate - this.endRate) / this.speed), this.speed ? (Object(fn.a)(this.rafId), this.rafId = Object(fn.c)(this.animate)) : this.$emit("input", this.endRate)
                        },
                        immediate: !0
                    }
                },
                methods: {
                    animate: function () {
                        ...
                        this.$emit("input", bn(parseFloat(e.toFixed(1)))), (this.increase ? e < this.endRate : e > this.endRate) && (this.rafId = Object(fn.c)(this.animate))
                    }
                },
                render: function () {
                    var t = arguments[0];
            ...
            wn = kn({
                ...
                render: function () {
                    ...
                    return e(this.tag, {
                        style: this.style,
                        class: xn((t = {}, t[i] = i, t["offset-" + n] = n, t)),
                        on: {
                            click: this.onClick
                        }
                    }, [this.slots()])
            ...
            $n = On({
                ...
                render: function () {
                    var t, e = arguments[0];
                    return e("div", {
                        class: [Tn(), (t = {}, t[$t] = this.border, t)]
                    }, [this.slots()])
                }
            }),
            Bn = Object(o.a)("collapse-item"),
            In = Bn[0],
            jn = Bn[1],
            En = ["title", "icon", "right-icon"],
            Dn = In({
                ...
                computed: {
                    currentName: function () {
                        return Object(m.b)(this.name) ? this.name : this.index
                    },
                    expanded: function () {
                        var t = this;
                ...
                watch: {
                    expanded: function (t, e) {
                        var i = this;
                        null !== e && (t && (this.show = !0, this.inited = !0), (t ? this.$nextTick : fn.c)((function () {
                            var e = i.$refs,
                                n = e.content,
                                s = e.wrapper;
                            if (n && s) {
                                ...
                                if (r) {
                                    var o = r + "px";
                                    s.style.height = t ? 0 : o, Object(fn.b)((function () {
        ...
        function zn(t, e, i, n) {
            ...
            }, h(n)]), ["add" === s ? e.addText || An("addText") : [t("div", [An("name") + "锛�" + e.name]), t("div", [An("tel") + "锛�" + e.tel])]])
        }
        zn.props = {
            tel: String,
            name: String,
        ...
        var Mn = Ln(zn),
            ...
            Wn = Vn({
                ...
                render: function () {
                    ...
                    })]), this.showSetDefault && e(se, {
                        attrs: {
                            title: this.setDefaultLabel,
                            border: !1
                        },
                        class: Rn("switch-cell")
                    }, [e(Ye, {
                        attrs: {
                            size: 24
                        },
            ...
            var s = e.list && e.list.map((function (i, s) {
                ...
                return t(se, {
                    ...
                    scopedSlots: {
                        ...
                        default: function () {
                            var n = [i.name + "锛�" + i.tel];
                            return i.isDefault && e.defaultTagText && n.push(t(mi, {
                                attrs: {
                                    type: "danger",
                                    round: !0
                                },
        ...
        var Zn = Object(o.a)("count-down"),
            ...
            es = Jn({
                    ...
                    formattedTime: function () {
                        return function (t, e) {
                            var i = e.days,
                                ...
                                r = e.seconds,
                                o = e.milliseconds;
                            if (-1 === t.indexOf("DD") ? n += 24 * i : t = t.replace("DD", Object(Gn.b)(i)), -1 === t.indexOf("HH") ? s += 60 * n : t = t.replace("HH", Object(Gn.b)(n)), -1 === t.indexOf("mm") ? r += 60 * s : t = t.replace("mm", Object(Gn.b)(s)), -1 === t.indexOf("ss") ? o += 1e3 * r : t = t.replace("ss", Object(Gn.b)(r)), -1 !== t.indexOf("S")) {
                                var a = Object(Gn.b)(o, 3);
                ...
                methods: {
                    ...
                    pause: function () {
                        this.counting = !1, Object(fn.a)(this.rafId)
                    },
                    reset: function () {
                    ...
                    microTick: function () {
                        var t = this;
                        this.rafId = Object(fn.c)((function () {
        ...
        function os(t) {
            ...
            return e.getFullYear() + "." + Object(Gn.b)(e.getMonth() + 1) + "." + Object(Gn.b)(e.getDate())
        }
        ...
        var ls = ns({
                ...
                computed: {
                    ...
                    faceAmount: function () {
                        ...
                        if (e.denominations) {
                            var i = as(e.denominations);
                            return "<span>" + this.currency + "</span> " + i
                        }
                        return e.discount ? rs("discount", ((t = e.discount) / 10).toFixed(t % 10 == 0 ? 0 : 1)) : ""
                    },
                    conditionMessage: function () {
                        var t = as(this.coupon.originCondition);
                        return "0" === t ? rs("unlimited") : rs("condition", t)
                    }
                },
                render: function () {
                    var t = arguments[0],
                    ...
                    return t("div", {
                        ...
                        class: ss("valid")
                    }, [this.validPeriod]), !this.disabled && t(ln, {
                        attrs: {
                            size: 18,
                            value: this.chosen,
                            checkedColor: wt
            ...
            var s = e.coupons[+e.chosenCoupon] ? "van-coupon-cell--selected" : "",
                o = function (t) {
                    var e = t.coupons,
                        ...
                        n = t.currency,
                        s = e[+i];
                    return s ? "-" + n + ((s.value || s.denominations || 0) / 100).toFixed(2) : 0 === e.length ? ds("tips") : ds("count", e.length)
                }(e);
            return t(se, r()([{
                class: hs(),
                attrs: {
        ...
        var ks = Object(o.a)("tab"),
            ...
            Cs = xs({
                ...
                methods: {
                    ...
                    genText: function () {
                        ...
                        return this.dot || Object(m.b)(this.info) && "" !== this.info ? t("span", {
                            class: ws("text-wrapper")
                        }, [e, t(Z, {
                            attrs: {
                                dot: this.dot,
                                info: this.info
            ...
            Bs = Ts({
                ...
                computed: {
                    offsetTopPx: function () {
                        return Object(U.b)(this.offsetTop)
                    },
                    style: function () {
                        if (this.fixed) {
                            var t = {};
                            return Object(m.b)(this.zIndex) && (t.zIndex = this.zIndex), this.offsetTopPx && this.fixed && (t.top = this.offsetTopPx + "px"), this.transform && (t.transform = "translate3d(0, " + this.transform + "px, 0)"), t
                        }
                    }
                },
                created: function () {
                    var t = this;
                    !m.f && window.IntersectionObserver && (this.observer = new IntersectionObserver((function (e) {
            ...
            Ps = Ns[1],
            As = Ls({
                mixins: [oi("vanTabs"), _((function (t) {
                    this.scroller || (this.scroller = P(this.$el)), t(window, "resize", this.resize, !0), this.scrollspy && t(this.scroller, "scroll", this.onScroll, !0)
                }))],
                model: {
                    prop: "active"
                },
                ...
                watch: {
                    ...
                    currentIndex: function () {
                        this.scrollIntoView(), this.setLine(), this.stickyFixed && !this.scrollspy && F(Math.ceil(V(this.$el) - this.offsetTop))
                    },
                ...
                methods: {
                        ...
                        this.$nextTick((function () {
                            ...
                            if (i && i[t.currentIndex] && "line" === t.type && !Ss(t.$el)) {
                                var n = i[t.currentIndex].$el,
                                    s = t.lineWidth,
                                    r = t.lineHeight,
                                    o = Object(m.b)(s) ? s : n.offsetWidth / 2,
                                ...
                                if (e && (l.transitionDuration = t.duration + "s"), Object(m.b)(r)) {
                                    var c = Object(U.a)(r);
                    ...
                    setCurrentIndex: function (t) {
                        if (t = this.findAvailableTab(t), Object(m.b)(t) && t !== this.currentIndex) {
                    ...
                    scrollIntoView: function (t) {
                        ...
                        if (this.scrollable && e && e[this.currentIndex]) {
                            ...
                            ! function (t, e, i) {
                                ...
                                ! function i() {
                                    t.scrollLeft += (e - s) / r, ++n < r && (ps = Object(fn.c)(i))
                                }()
                    ...
                    scrollToCurrentContent: function () {
                        ...
                        if (this.scrollspy) {
                            ...
                            if (i) {
                                var n = V(i, this.scroller) - this.scrollOffset;
                                this.lockScroll = !0,
                                    function (t, e, i, n) {
                                        var s = A(t),
                                            r = s < e,
                                            ...
                                            a = (e - s) / o;
                                        ! function i() {
                                            s += a, (r && s > e || !r && s < e) && (s = e), z(t, s), r && s < e || !r && s > e ? Object(fn.c)(i) : n && Object(fn.c)(n)
                                        }()
                    ...
                    getCurrentIndexOnScroll: function () {
                        for (var t, e = this.children, i = 0; i < e.length; i++) {
                            if ((N(t = e[i].$el) ? 0 : t.getBoundingClientRect().top) > this.scrollOffset) return 0 === i ? 0 : i - 1
                        }
                        return e.length - 1
                    }
                },
                        ...
                        a = this.children.map((function (t, r) {
                            return i(Cs, {
                                ...
                                attrs: {
                                    type: n,
                                    dot: t.dot,
                                    info: Object(m.b)(t.badge) ? t.badge : t.info,
                                    title: t.title,
                                    color: e.color,
            ...
            Rs = Ms({
                ...
                render: function () {
                    var t = this,
                        ...
                        r = (this.enabledTitle || Vs("enable")) + s,
                        o = this.showCount ? " (" + n.length + ")" : "",
                        a = (this.disabledTitle || Vs("disabled")) + o,
                        l = this.showExchangeBar && e("div", {
                            class: Fs("exchange-bar")
                        }, [e(le, {
                            attrs: {
                                clearable: !0,
                                border: !1,
            ...
            Ws = (0, Object(o.a)("time-picker")[0])({
                ...
                methods: {
                    formatValue: function (t) {
                        t || (t = Object(Gn.b)(this.minHour) + ":" + Object(Gn.b)(this.minMinute));
                        var e = t.split(":"),
                            i = e[0],
                            n = e[1];
                        return (i = Object(Gn.b)(jt(i, this.minHour, this.maxHour))) + ":" + (n = Object(Gn.b)(jt(n, this.minMinute, this.maxMinute)))
                    },
            ...
            qs = (new Date).getFullYear(),
            Ys = (0, Object(o.a)("date-picker")[0])({
                mixins: [_s],
                props: n(n({}, Hs), {}, {
                    type: {
                        type: String,
                ...
                methods: {
                    formatValue: function (t) {
                        return Ei(t) || (t = this.minDate), t = Math.max(t, this.minDate.getTime()), t = Math.min(t, this.maxDate.getTime()), new Date(t)
                    },
                    getBoundary: function (t, e) {
                        var i, n = this[t + "Date"],
                            ...
                            a = 0,
                            l = 0;
                        return "max" === t && (r = 12, o = Hi(e.getFullYear(), e.getMonth() + 1), a = 23, l = 59), e.getFullYear() === s && (r = n.getMonth() + 1, e.getMonth() + 1 === r && (o = n.getDate(), e.getDate() === o && (a = n.getHours(), e.getHours() === a && (l = n.getMinutes())))), (i = {})[t + "Year"] = s, i[t + "Month"] = r, i[t + "Date"] = o, i[t + "Hour"] = a, i[t + "Minute"] = l, i
                    },
                    updateInnerValue: function () {
                        var t, e, i, n = this,
                            s = this.type,
                            ...
                            o = function (t) {
                                return function (t) {
                                    if (!t) return 0;
                                    for (; Object(ji.a)(parseInt(t, 10));) {
                                        if (!(t.length > 1)) return 0;
                                        t = t.slice(1)
                                    }
                                    return parseInt(t, 10)
                                }(n.originColumns[t].values[r[t]])
                            };
                        "month-day" === s ? (t = this.innerValue.getFullYear(), e = o(0), i = o(1)) : (t = o(0), e = o(1), i = "year-month" === s ? 1 : o(2));
                        var a = Hi(t, e);
                        i = i > a ? a : i;
                        var l = 0,
                            c = 0;
                        "datetime" === s && (l = o(3), c = o(4));
                    ...
                    updateColumnValue: function () {
                        var t = this,
                            e = this.innerValue,
                            i = this.formatter,
                            n = [i("year", "" + e.getFullYear()), i("month", Object(Gn.b)(e.getMonth() + 1)), i("day", Object(Gn.b)(e.getDate()))];
                        "datetime" === this.type && n.push(i("hour", Object(Gn.b)(e.getHours())), i("minute", Object(Gn.b)(e.getMinutes()))), "year-month" === this.type && (n = n.slice(0, 2)), "month-day" === this.type && (n = n.slice(1, 3)), this.$nextTick((function () {
                            t.getPicker().setValues(n)
                        }))
                    }
                }
            }),
            Us = Object(o.a)("datetime-picker"),
            Ks = Us[0],
            Xs = Us[1],
            Qs = Ks({
                props: n(n({}, Ws.props), Ys.props),
                methods: {
                    getPicker: function () {
        ...
        var er = Zs(tr),
            ...
            ar = Object(o.a)("dropdown-menu"),
            lr = ar[0],
            cr = ar[1],
            ur = lr({
                mixins: [oi("vanDropdownMenu"), or({
                    event: "click",
                ...
                computed: {
                    ...
                    barStyle: function () {
                        if (this.opened && Object(m.b)(this.zIndex)) return {
                ...
                methods: {
                    genImageContent: function () {
                        var t = this.$createElement,
                            e = this.slots("image");
                        if (e) return e;
                        if ("network" === this.image) return t(hr);
                        var i = this.image;
                        return -1 !== mr.indexOf(i) && (i = "https://img.yzcdn.cn/vant/empty-image-" + i + ".png"), t("img", {
                            attrs: {
                                src: i
                            }
                        })
                ...
                methods: {
                    ...
                    scrollToField: function (t, e) {
                        this.fields.forEach((function (i) {
                            i.name === t && i.$el.scrollIntoView(e)
                        }))
                    },
                    addField: function (t) {
            ...
            Or = Object(o.a)("goods-action-button"),
            Tr = Or[0],
            $r = Or[1],
            Br = Tr({
            ...
            Ir = Object(o.a)("goods-action-icon"),
            jr = Ir[0],
            Er = Ir[1],
            Dr = jr({
                mixins: [ri("vanGoodsAction")],
                ...
                methods: {
                    ...
                    genIcon: function () {
                        var t = this.$createElement,
                            e = this.slots("icon"),
                            i = Object(m.b)(this.badge) ? this.badge : this.info;
                        return e ? t("div", {
                            class: Er("icon")
                        }, [e, t(Z, {
                            attrs: {
            ...
            Ar = Lr({
                ...
                render: function () {
                    ...
                    return e("div", {
                        style: this.style,
                        class: [Pr(), (t = {}, t[Ot] = this.border && !this.gutter, t)]
                    }, [this.slots()])
                }
            }),
            ...
            _r = Rr[1],
            Wr = Hr({
                mixins: [R, oi("vanSwipe"), _((function (t, e) {
                ...
                methods: {
                    initialize: function (t) {
                        if (void 0 === t && (t = +this.initialSwipe), this.$el && !Ss(this.$el)) {
                    ...
                    prev: function () {
                        var t = this;
                        this.correctPosition(), this.resetTouchStatus(), Object(fn.b)((function () {
                            t.swiping = !1, t.move({
                                pace: -1,
                                emitChange: !0
                            })
                    ...
                    swipeTo: function (t, e) {
                        var i = this;
                        void 0 === e && (e = {}), this.correctPosition(), this.resetTouchStatus(), Object(fn.b)((function () {
                            var n;
                            n = i.loop && t === i.count ? 0 === i.active ? 0 : t : t % i.count, e.immediate ? Object(fn.b)((function () {
                                i.swiping = !1
                            })) : i.swiping = !1, i.move({
                                pace: n - i.active,
                                emitChange: !0
        ...
        var Jr, to = Qr({
                ...
                data: function () {
                    return this.imageSizes = [], this.windowWidth = window.innerWidth, this.windowHeight = window.innerHeight, {
                        scale: 1,
                        moveX: 0,
                        moveY: 0,
                        active: 0,
                ...
                computed: {
                    imageStyle: function () {
                        ...
                        return 1 !== t && (e.transform = "scale(" + t + ", " + t + ") translate(" + this.moveX / t + "px, " + this.moveY / t + "px)"), e
                    }
                },
                watch: {
                    ...
                    shouldRender: {
                        handler: function (t) {
                            ...
                            t && this.$nextTick((function () {
                                ...
                                b(t, "touchstart", e.onWrapperTouchStart), b(t, "touchmove", k), b(t, "touchend", e.onWrapperTouchEnd), b(t, "touchcancel", e.onWrapperTouchEnd)
                            }))
                        },
                        immediate: !0
                    }
                ...
                methods: {
                    ...
                    onWrapperTouchEnd: function (t) {
                        ...
                        var i = new Date - this.touchStartTime,
                            ...
                            r = void 0 === s ? 0 : s,
                            o = n.offsetY;
                        i < 250 && r < 10 && (void 0 === o ? 0 : o) < 10 && (this.doubleClickTimer ? (clearTimeout(this.doubleClickTimer), this.doubleClickTimer = null, this.toggleScale()) : this.doubleClickTimer = setTimeout((function () {
                            e.emitClose(), e.doubleClickTimer = null
                        }), 250))
                    },
                    startMove: function (t) {
                        var e = t.currentTarget;
                        this.touchStart(t), this.setMaxMove(e.dataset.index), this.moving = !0, this.startMoveX = this.moveX, this.startMoveY = this.moveY
                    },
                    setMaxMove: function (t) {
                        var e = this.scale,
                            i = this.windowWidth,
                            n = this.windowHeight;
                        if (this.imageSizes[t]) {
                            var s = this.imageSizes[t],
                                r = s.displayWidth,
                                o = s.displayHeight;
                            this.maxMoveX = Math.max(0, (r * e - i) / 2), this.maxMoveY = Math.max(0, (o * e - n) / 2)
                        } else this.maxMoveX = 0, this.maxMoveY = 0
                    },
                    startZoom: function (t) {
                        this.moving = !1, this.zooming = !0, this.startScale = this.scale, this.startDistance = Zr(t.touches)
                    },
                    onImageLoad: function (t, e) {
                        var i, n, s = this.windowWidth,
                            r = this.windowHeight,
                            o = t.target,
                            a = o.naturalWidth,
                            l = o.naturalHeight,
                            c = l / a;
                        c < r / s ? (i = s, n = s * c) : (i = r / c, n = r), this.imageSizes[e] = {
                            naturalWidth: a,
                            naturalHeight: l,
                            displayWidth: i,
                            displayHeight: n
                    ...
                    onImageTouchMove: function (t) {
                        var e = t.touches;
                        if ((this.moving || this.zooming) && k(t, !0), this.moving) {
                            this.touchMove(t);
                    ...
                    onImageTouchEnd: function (t) {
                        if (this.moving || this.zooming) {
                            var e = !0;
                            this.moving && this.startMoveX === this.moveX && this.startMoveY === this.moveY && (e = !1), t.touches.length || (this.moving = !1, this.zooming = !1, this.startMoveX = 0, this.startMoveY = 0, this.startScale = 1, this.scale < 1 && this.resetScale()), e && k(t, !0)
                        }
                    },
                    ...
                    genClose: function () {
                        ...
                        if (this.closeable) return t(st, {
                            ...
                            class: Gr("close-icon", this.closeIconPosition),
                            on: {
            ...
            io = function (t, e) {
                if (void 0 === e && (e = 0), !m.f) {
                    Jr || (Jr = new(l.a.extend(to))({
                        el: document.createElement("div")
                    }), document.body.appendChild(Jr.$el), Jr.$on("change", (function (t) {
                        Jr.onChange && Jr.onChange(t)
                    })), Jr.$on("scale", (function (t) {
                        Jr.onScale && Jr.onScale(t)
                    })));
                    var i = Array.isArray(t) ? {
                        images: t,
                        startPosition: e
                    } : t;
                    return n(Jr, eo, i), Jr.$once("input", (function (t) {
                        Jr.value = t
                    })), Jr.$once("closed", (function () {
                        Jr.images = []
                    })), i.onClose && (Jr.$off("close"), Jr.$once("close", i.onClose)), Jr
                }
            };
        io.Component = to, io.install = function () {
            l.a.use(to)
        };
        var no = io,
            so = Object(o.a)("index-anchor"),
            ro = so[0],
            oo = so[1],
            ao = ro({
                mixins: [ri("vanIndexBar", {
        ...
        var lo = Object(o.a)("index-bar"),
            co = lo[0],
            uo = lo[1],
            ho = co({
                mixins: [R, oi("vanIndexBar"), _((function (t) {
                ...
                computed: {
                    sidebarStyle: function () {
                        if (Object(m.b)(this.zIndex)) return {
                ...
                methods: {
                    ...
                    getElementTop: function (t, e) {
                        var i = this.scroller;
                        return i === window || i === document.body ? V(t) : t.getBoundingClientRect().top - e.top + A(i)
                    },
                ...
                methods: {
                    ...
                    genLoading: function () {
                        ...
                        if (this.innerLoading && !this.finished) return t("div", {
                            class: go("loading"),
                            key: "loading"
                        }, [this.slots("loading") || t(mt, {
                            attrs: {
                                size: "16"
                            }
                        }, [this.loadingText || bo("loading")])])
                    },
            ...
            Bo = To({
                ...
                methods: {
                    ...
                    onTransitionEnd: function () {
                        var t = this;
                        this.offset = this.wrapWidth, this.duration = 0, setTimeout((function () {
                    ...
                    start: function () {
                        var t = this,
                            e = Object(m.b)(this.delay) ? 1e3 * this.delay : 0;
                        this.reset(), setTimeout((function () {
                            ...
                            if (i && n && !1 !== t.scrollable) {
                                ...
                                (t.scrollable || r > s) && Object(fn.b)((function () {
                ...
                render: function () {
                    ...
                    function c() {
                        ...
                        return s || ("closeable" === n ? t = "cross" : "link" === n && (t = "arrow"), t ? e(st, {
                            class: $o("right-icon"),
                            attrs: {
                                name: t
                            },
        ...
        function Ao(t) {
            ...
            })), t = n(n({}, Ao.currentOptions), (e = t, Object(m.d)(e) ? e : {
                message: e
            })), n(Lo, t), clearTimeout(No), t.duration && t.duration > 0 && (No = setTimeout(Ao.clear, t.duration)), Lo
        }
        Ao.clear = function () {
            Lo && (Lo.value = !1)
        }, Ao.currentOptions = {
            ...
            onClick: null,
            onOpened: null
        }, Ao.setDefaultOptions = function (t) {
            n(Ao.currentOptions, t)
            ...
            l.a.use(Po)
        }, Ao.Component = Po, l.a.prototype.$notify = Ao;
        var zo = Ao,
            Mo = {
                render: function () {
                    var t = arguments[0];
        ...
        function la(t, e, i, n) {
            for (var s, o = e.mask, a = e.value, l = e.length, c = e.gutter, u = e.focused, f = e.errorInfo, p = f || e.info, m = [], v = 0; v < l; v++) {
                var g, b = a[v],
                    ...
                    k = void 0;
                0 !== v && c && (k = {
                    marginLeft: Object(U.a)(c)
                }), m.push(t("li", {
                    class: (g = {}, g["van-hairline--left"] = y, g),
                    style: k
                }, [o ? t("i", {
                    style: {
            ...
            return t("div", {
                ...
                class: [aa("security"), (s = {}, s["van-hairline--surround"] = !c, s)],
                on: {
                    touchstart: function (t) {
        ...
        var ca = oa(la),
                ...
                render: function () {
                    var t = arguments[0],
                        ...
                        l = {
                            ...
                            height: Object(U.a)(this.strokeWidth)
                        };
                    return t("div", {
                        class: da(),
                        style: l
            ...
            pa = Object(o.a)("pull-refresh"),
            ma = pa[0],
            va = pa[1],
            ga = pa[2],
            ba = ["pulling", "loosing", "success"],
            ya = ma({
                mixins: [R],
                props: {
                    disabled: Boolean,
                ...
                methods: {
                    ...
                    genStatus: function () {
                        ...
                        var s = [],
                            r = this[e + "Text"] || ga(e);
                        return -1 !== ba.indexOf(e) && s.push(t("div", {
                            class: va("text")
                        }, [r])), "loading" === e && s.push(t(mt, {
                            attrs: {
                                size: "16"
                            }
                        }, [r])), s
        ...
        var wa = ka({
                ...
                computed: {
                    ...
                    sizeWithUnit: function () {
                        return Object(U.a)(this.size)
                    },
                    gutterWithUnit: function () {
                        return Object(U.a)(this.gutter)
                    }
                },
                mounted: function () {
                    this.bindTouchEvent(this.$el)
        ...
        function Da(t, e, i, s) {
            ...
            return a.attrs = void 0, t("div", r()([{
                ...
                }, [i.action ? i.action() : e.actionText || Ea("cancel")])
            }()])
        }
        Da.props = {
            value: String,
        ...
        var Na = Ia(Da),
            ...
            Fa = Aa({
                ...
                methods: {
                    ...
                    genCancelText: function () {
                        var t = this.$createElement,
                            e = Object(m.b)(this.cancelText) ? this.cancelText : Ma("cancel");
            ...
            Ua = qa({
                ...
                methods: {
                    onClick: function () {
                        this.disabled || (this.$emit("click", this.index), this.parent.$emit("input", this.index), this.parent.setIndex(this.index), Qt(this.$router, this))
                    }
                },
                render: function () {
                    var t = arguments[0];
                    return t("a", {
                        ...
                        attrs: {
                            dot: this.dot,
                            info: Object(m.b)(this.badge) ? this.badge : this.info
                        },
                        class: Ya("info")
                    })])])
                }
            }),
            Ka = Object(o.a)("skeleton"),
            Xa = Ka[0],
            Qa = Ka[1];
        ...
        function Ga(t, e, i, n) {
            ...
            return t("div", r()([{
                ...
                if (e.avatar) {
                    var i = Object(U.a)(e.avatarSize);
                    return t("div", {
                        class: Qa("avatar", e.avatarShape),
                        style: {
                            width: i,
                            height: i
                        }
                ...
                for (var i, n = [], s = e.rowWidth, r = 0; r < e.row; r++) n.push(t("div", {
                    class: Qa("row"),
                    style: {
                        width: Object(U.a)((i = r, "100%" === s && i === +e.row - 1 ? "60%" : Array.isArray(s) ? s[i] : s))
                    }
                }));
                return n
            }()])])
        ...
        var Za = Xa(Ga),
            ...
            ll = {
                normalizeSkuTree: el,
                getSkuComb: nl,
                getSelectedSkuValues: sl,
                isAllSelected: il,
                isSkuChoosable: rl,
                getSelectedPropValues: ol,
                getSelectedProperties: al
            },
            cl = Object(o.a)("sku-header"),
            ul = cl[0],
            hl = cl[1];
        ...
        var fl = ul(dl),
            pl = Object(o.a)("sku-header-item"),
            ml = pl[0],
            vl = pl[1];
        var gl = ml((function (t, e, i, n) {
                return t("div", r()([{
                    class: vl()
                }, h(n)]), [i.default && i.default()])
            })),
            bl = Object(o.a)("sku-row"),
            yl = bl[0],
            Sl = bl[1],
            kl = bl[2];
        ...
        var wl = yl(xl),
            Cl = (0, Object(o.a)("sku-row-item")[0])({
                ...
                computed: {
                    choosable: function () {
                        return rl(this.skuList, this.selectedSku, {
                            key: this.skuKeyStr,
            ...
            Ol = (0, Object(o.a)("sku-row-prop-item")[0])({
                props: {
                    skuValue: Object,
                    skuKeyStr: String,
                    skuEventBus: Object,
        ...
        var jl = $l({
                ...
                data: function () {
                    var t = Object(m.b)(this.value) ? this.value : this.defaultValue,
                        e = this.format(t);
                    return Il(e, this.value) || this.$emit("input", e), {
                        currentValue: e
                    }
                },
                computed: {
                    ...
                    inputStyle: function () {
                        var t = {};
                        return this.inputWidth && (t.width = Object(U.a)(this.inputWidth)), this.buttonSize && (t.height = Object(U.a)(this.buttonSize)), t
                    },
                    buttonStyle: function () {
                        if (this.buttonSize) {
                            var t = Object(U.a)(this.buttonSize);
                            return {
                                width: t,
                                height: t
                            }
                ...
                methods: {
                    check: function () {
                        ...
                        Il(t, this.currentValue) || (this.currentValue = t)
                    },
                    formatNumber: function (t) {
                        return Dt(String(t), !this.integer)
                    },
                    format: function (t) {
                        return t = "" === (t = this.formatNumber(t)) ? 0 : +t, t = Object(ji.a)(t) ? this.min : t, t = Math.max(Math.min(this.max, t), this.min), Object(m.b)(this.decimalLength) && (t = t.toFixed(this.decimalLength)), t
                    },
                    onInput: function (t) {
                        var e = t.target.value,
                            i = this.formatNumber(e);
                        if (Object(m.b)(this.decimalLength) && -1 !== i.indexOf(".")) {
                            var n = i.split(".");
                    ...
                    onBlur: function (t) {
                        ...
                        t.target.value = e, this.currentValue = e, this.$emit("blur", t), Xt()
                    },
            ...
            Al = Dl({
                ...
                computed: {
                    stepperLimit: function () {
                        ...
                        return this.quota > 0 && e <= this.stock ? (t = e < 0 ? 0 : e, this.limitType = Ll) : (t = this.stock, this.limitType = Pl), t
                    },
                    ...
                    quotaText: function () {
                        ...
                        if (e) i = e;
                            ...
                            var n = [];
                            this.startSaleNum > 1 && n.push(Nl("quotaStart", this.startSaleNum)), this.quota > 0 && n.push(Nl("quotaLimit", this.quota)), i = n.join(Nl("comma"))
                        }
                        return i
                    }
                },
        ...
        var Vl = /\.(jpeg|jpg|gif|png|svg|webp|jfif|bmp|dpg)/i;

        function Rl(t) {
            return !!t.isImage || (t.file && t.file.type ? 0 === t.file.type.indexOf("image") : t.url ? (e = t.url, Vl.test(e)) : !!t.content && 0 === t.content.indexOf("data:image"));
            var e
        }
        var Hl = Object(o.a)("uploader"),
            ...
            ql = _l({
                ...
                computed: {
                    previewSizeWithUnit: function () {
                        return Object(U.a)(this.previewSize)
                    },
                    value: function () {
                ...
                methods: {
                    ...
                    onChange: function (t) {
                        ...
                        if (!this.disabled && i.length) {
                            if (i = 1 === i.length ? i[0] : [].slice.call(i), this.beforeRead) {
                                ...
                                if (Object(m.e)(n)) return void n.then((function (t) {
                    ...
                    readFile: function (t) {
                        ...
                        } else Fl(t, this.resultType).then((function (n) {
                            var s = {
                                file: t,
                                status: "",
                                message: ""
                    ...
                    onAfterRead: function (t, e) {
                        ...
                        }(Array.isArray(n) ? Boolean(n.length) : Boolean(n)) && (this.$emit("input", [].concat(this.fileList, Ml(n))), this.afterRead && this.afterRead(n, this.getDetail()))
                    },
                    onDelete: function (t, e) {
                        ...
                        if (this.beforeDelete) {
                            ...
                            if (!n) return;
                            if (Object(m.e)(n)) return void n.then((function () {
                                i.deleteFile(t, e)
                            })).catch(m.g)
                        }
                        this.deleteFile(t, e)
                    ...
                    genPreviewItem: function (t, e) {
                        var i = this,
                            n = this.$createElement,
                            s = "uploading" !== t.status && this.deletable && n(st, {
                                attrs: {
                                    name: "clear"
                                },
                                class: Wl("preview-delete"),
                                on: {
                                    click: function (n) {
                            ...
                            r = Rl(t) ? n(Xi, {
                                ...
                                class: [Wl("file-name"), "van-ellipsis"]
                    ...
                    genUpload: function () {
                        ...
                        if (!(this.fileList.length >= this.maxCount) && this.showUpload) {
                            ...
                            return t("div", {
                                ...
                                class: Wl("upload-icon")
                            }), this.uploadText && t("span", {
                                class: Wl("upload-text")
                            }, [this.uploadText]), s])
                        }
                    }
                },
            ...
            Yl = Object(o.a)("sku-img-uploader"),
            Ul = Yl[0],
            Kl = Yl[1],
            Xl = Yl[2],
            Ql = Ul({
            ...
            ec = Zl({
                ...
                methods: {
                    ...
                    getPlaceholder: function (t) {
                        ...
                        return t.placeholder || i[e] || tc("placeholder." + e)
                    },
                    validateMessages: function () {
                        for (var t = this.messageValues, e = 0; e < t.length; e++) {
                            var i = t[e].value,
                                n = this.messages[e];
                            if ("" === i) {
                                if ("1" === String(n.required)) return tc("image" === n.type ? "upload" : "fill") + n.name
                            } else {
                                if ("tel" === n.type && !Object(ji.b)(i)) return tc("invalid.tel");
                                if ("mobile" === n.type && !/^\d{6,20}$/.test(i)) return tc("invalid.mobile");
                                if ("email" === n.type && !zl(i)) return tc("invalid.email");
                                if ("id_no" === n.type && (i.length < 15 || i.length > 18)) return tc("invalid.id_no")
                            }
                        }
                    },
                    genMessage: function (t, e) {
                        var i = this,
                            n = this.$createElement;
                        return "image" === t.type ? n(se, {
                            key: this.goodsId + "-" + e,
                            attrs: {
                                title: t.name,
                                label: tc("imageLabel"),
                                required: "1" === String(t.required),
                                valueClass: Jl("image-cell-value")
                            },
                            class: Jl("image-cell")
                        }, [n(Ql, {
                            attrs: {
        ...
        function oc(t, e, i, n) {
            ...
            return t("div", r()([{
                class: sc()
            }, h(n)]), [e.showAddCartBtn && t($e, {
                attrs: {
                    size: "large",
                    type: "warning",
                    text: e.addCartText || rc("addCart")
                },
                on: {
                    click: s("sku:addCart")
                }
            ...
            fc = cc({
                ...
                computed: {
                    ...
                    isSkuCombSelected: function () {
                        var t = this;
                        return !(this.hasSku && !il(this.skuTree, this.selectedSku)) && !this.propList.some((function (e) {
                    ...
                    selectedSkuComb: function () {
                        var t = null;
                        return this.isSkuCombSelected && (t = this.hasSku ? nl(this.sku.list, this.selectedSku) : {
                            id: this.sku.collection_id,
                            price: Math.round(100 * this.sku.price),
                            stock_num: this.sku.stock_num
                        }) && (t.properties = al(this.propList, this.selectedProp), t.property_price = this.selectedPropValues.reduce((function (t, e) {
                            return t + (e.price || 0)
                        }), 0)), t
                    },
                    selectedSkuValues: function () {
                        return sl(this.skuTree, this.selectedSku)
                    },
                    selectedPropValues: function () {
                        return ol(this.propList, this.selectedProp)
                    },
                    price: function () {
                    ...
                    stockText: function () {
                        ...
                        return e ? e(this.stock) : [hc("stock") + " ", t("span", {
                            class: uc("stock-num", {
                                highlight: this.stock < this.stockThreshold
                            })
                        }, [this.stock]), " " + hc("stockUnit")]
                    },
                    selectedText: function () {
                        var t = this;
                        if (this.selectedSkuComb) {
                            var e = this.selectedSkuValues.concat(this.selectedPropValues);
                            return hc("selected") + " " + e.map((function (t) {
                                return t.name
                            })).join("锛�")
                        }
                        ...
                        return hc("select") + " " + i.concat(n).join("锛�")
                    }
                },
                created: function () {
                    var t = new l.a;
                ...
                methods: {
                    resetStepper: function () {
                        var t = this.$refs.skuStepper,
                            ...
                            i = Object(m.b)(e) ? e : this.startSaleNum;
                    ...
                    resetSelectedSku: function () {
                        ...
                        this.selectedSku = {}, this.skuTree.forEach((function (e) {
                            ...
                            var i = e.k_s,
                                n = e.v[0].id;
                            1 === e.v.length && rl(t.sku.list, t.selectedSku, {
                                key: i,
                                valueId: n
                            }) && (t.selectedSku[i] = n)
                        }));
                    ...
                    validateSku: function () {
                        if (0 === this.selectedNum) return hc("unavailable");
                    ...
                    onSelect: function (t) {
                        var e, i;
                        this.selectedSku = this.selectedSku[t.skuKeyStr] === t.id ? n(n({}, this.selectedSku), {}, ((e = {})[t.skuKeyStr] = "", e)) : n(n({}, this.selectedSku), {}, ((i = {})[t.skuKeyStr] = t.id, i)), this.$emit("sku-selected", {
                            skuValue: t,
                            selectedSku: this.selectedSku,
                            selectedSkuComb: this.selectedSkuComb
                        })
                    ...
                    onPropSelect: function (t) {
                        var e, i = this.selectedProp[t.skuKeyStr] || [],
                            s = i.indexOf(t.id);
                        s > -1 ? i.splice(s, 1) : t.multiple ? i.push(t.id) : i.splice(0, 1, t.id), this.selectedProp = n(n({}, this.selectedProp), {}, ((e = {})[t.skuKeyStr] = i, e)), this.$emit("sku-prop-selected", {
                            propValue: t,
                            selectedProp: this.selectedProp,
                            selectedSkuComb: this.selectedSkuComb
                        })
                    ...
                    onOverLimit: function (t) {
                        ...
                        r ? r(t) : "minus" === e ? this.startSaleNum > 1 ? ke(hc("minusStartTip", this.startSaleNum)) : ke(hc("minusTip")) : "plus" === e && ke(i === dc ? s > 0 ? hc("quotaUsedTip", n, s) : hc("quotaTip", n) : hc("soldout"))
                    },
                ...
                render: function () {
                    ...
                    if (!this.isSkuEmpty) {
                        var i = this.sku,
                            ...
                            }, [this.priceTag])]), f("sku-header-origin-price") || r && e(gl, [hc("originPrice"), " 锟�", r]), !this.hideStock && e(gl, [e("span", {
        ...
        So.a.add({
            "zh-CN": {
                ...
                vanSkuImgUploader: {
                    oversize: function (t) {
                        return "鏈€澶у彲涓婁紶鍥剧墖涓�" + t + "MB锛岃灏濊瘯鍘嬬缉鍥剧墖灏哄"
                    },
                    fail: "涓婁紶澶辫触<br />閲嶆柊涓婁紶"
                },
                vanSkuStepper: {
                ...
                vanSkuMessages: {
                    ...
                    imageLabel: "浠呴檺涓€寮�",
                    invalid: {
                        tel: "璇峰～鍐欐纭殑鏁板瓧鏍煎紡鐣欒█",
                        mobile: "鎵嬫満鍙烽暱搴︿负6-20浣嶆暟瀛�",
                        email: "璇峰～鍐欐纭殑閭",
                        id_no: "璇峰～鍐欐纭殑韬唤璇佸彿鐮�"
                    },
                    placeholder: {
                        id_no: "杈撳叆韬唤璇佸彿鐮�",
                        text: "杈撳叆鏂囨湰",
        ...
        }), fc.SkuActions = ac, fc.SkuHeader = fl, fc.SkuHeaderItem = gl, fc.SkuMessages = ec, fc.SkuStepper = Al, fc.SkuRow = wl, fc.SkuRowItem = Cl, fc.SkuRowPropItem = Ol, fc.skuHelper = ll, fc.skuConstants = tl;
        var pc = fc,
            mc = Object(o.a)("slider"),
            vc = mc[0],
            gc = mc[1],
            bc = vc({
                mixins: [R, He],
            ...
            xc = Sc({
                ...
                computed: {
                    ...
                    lineStyle: function () {
                        if ("finish" === this.status && this.parent.activeColor) return {
            ...
            Tc = Cc({
                ...
                render: function () {
                    var t = arguments[0];
                    return t("div", {
                        class: Oc([this.direction])
                    }, [t("div", {
                        class: Oc("items")
                    }, [this.slots()])])
                }
            }),
            $c = Object(o.a)("submit-bar"),
            Bc = $c[0],
            Ic = $c[1],
            jc = $c[2];
            ...
            return t("div", r()([{
                ...
                if ("number" == typeof o) {
                    ...
                    return t("div", {
                        ...
                        class: Ic("price", "integer")
                    }, [i[0]]), n]), e.suffixLabel && t("span", {
                        class: Ic("suffix-label")
                    }, [e.suffixLabel])])
                }
            }(), t($e, {
                attrs: {
        ...
        var Dc = Bc(Ec),
            ...
            Wc = Hc({
                ...
                computed: {
                    routeActive: function () {
                        var t = this.to,
                            e = this.$route;
                        if (t && e) {
                            var i = Object(m.d)(t) ? t : {
                                    path: t
                                },
                                n = i.path === e.path,
                                s = Object(m.b)(i.name) && i.name === e.name;
                            return n || s
                        }
                    }
                },
                methods: {
                    onClick: function (t) {
                        this.parent.onChange(this.name || this.index), this.$emit("click", t), Qt(this.$router, this)
                    },
                    genIcon: function (t) {
                        var e = this.$createElement,
                            i = this.slots("icon", {
        ...
        function Gc(t) {
            [St, ni, Ii, Ut, $e, qi, tn, se, on, ln, dn, yn, wn, $n, Dn, Mn, Wn, Qn, es, ls, ms, Rs, Qs, Le, er, rr, ur, vr, le, Sr, Cr, Br, Dr, Ar, Vr, st, Xi, no, ao, ho, Z, yo, mt, So.a, Co, Bo, zo, Uo, $, Jo, sa, ca, Ht, lt, fa, ya, bi, ui, wa, $a, Na, Fa, _a, Ua, Za, pc, bc, xc, jl, Tc, Bs, Dc, Wr, Ac, Kr, Ye, Ge, ys, Vc, Wc, As, mi, ke, Xc, ql].forEach((function (e) {
