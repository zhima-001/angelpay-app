...
error_reporting(0);
header("Content-type: text/html; charset=utf-8");
$fxgetway="http://pay.meilinshidiao.com/pay";
$data = array(
    "fxid" => $merId, //商户号
    ...
    "fxattch" => 'mytest', //附加信息
    "fxnotifyurl" => "http://huitiao.freewing123.xyz/pay/aobama/notify/".TRADE_NO.'/', //异步回调 , 支付结果以异步为准
    "fxbackurl" => "http://huitiao.freewing123.xyz/pay/aobama/return/".TRADE_NO.'/', //同步回调 不作为最终支付结果为准，请以异步回调为准
