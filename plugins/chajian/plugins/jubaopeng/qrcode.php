...
$params = [
    ...
    'orderid'=>TRADE_NO,
    'callbackurl' => "https://".$_SERVER['HTTP_HOST']."/pay/jubaopeng/notify/".TRADE_NO.'/',
...
$params['sign'] = $sign;              //签名
$params['hrefbackurl'] = "https://".$_SERVER['HTTP_HOST']."/pay/jubaopeng/notify/".TRADE_NO.'/';


$notify_url =  "https://".$_SERVER['HTTP_HOST']."/pay/jubaopeng/notify/".TRADE_NO.'/';
$return_url =  "https://".$_SERVER['HTTP_HOST']."/pay/jubaopeng/notify/".TRADE_NO.'/';

$api = "http://pay.lwfpay.net/api.aspx";

//$sign ="parter=".$merId."&type=".$channel['appurl']."&value=".$order['money']."&orderid=".TRADE_NO."&callbackurl="."https://".$_SERVER['HTTP_HOST']."/pay/jubaopeng/notify/".TRADE_NO.'/'; 
//$sign=md5($sign.$key);  
$PostUrl=$api."?parter=".$merId."&type=".$channel['appurl']."&value=".$order['money']."&orderid=".TRADE_NO."&callbackurl=".$notify_url."&hrefbackurl=".$return_url."&sign=".$sign;
...
$submitData =  Http::get($api, $params);
// var_dump($submitData);
// exit();
...
if(!empty($submitData)){
    ...
    /*$url = $new_submitData['data']['pay_url'];
      $ch = curl_init($url);
   ...
   // $resp2 = Http::get($new_submitData['data']['pay_url']);

    // var_dump($content);
    // exit();
    // echo "<p>正在为您跳转到支付页面，请稍候...</p>";
    // echo "<script>";
    // echo "window.location.href='" . $submitData. "'";
    // echo ";</script>";
    // exit;
    echo $submitData;
