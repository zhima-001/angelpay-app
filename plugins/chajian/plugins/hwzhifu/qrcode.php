...
//请求地址
$api = "https://api.hwpay.io/c/payment/pay";

$native = array(
    "customerNo" => $merId,
    "payTypeId" => $channel['appurl'],
    "amount" => $order['money'],
    "orderNo" => TRADE_NO,
    "title"=>"充值",
    "customerCallbackUrl" => "http://huitiao.freewing123.xyz/pay/hwzhifu/notify/".TRADE_NO.'/',  
...
$submitData = \lib\Zhifu::http_posts_json($api,$native);
...
if($arr['success']){
    ...
    echo "<script>";
    echo "window.location.href='" .  $arr['data']['url'] . "'";
    echo ";</script>";
    exit; 
}else{
    echo "拉取支付失败";
