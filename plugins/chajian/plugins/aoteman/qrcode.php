...
$native = array(
       ...
       "pay_amount" => (int)$order['money'],

        "pay_bankcode" => $channel['appurl'],
        "pay_notifyurl" => "http://huitiao.freewing123.xyz/pay/aoteman/notify/".TRADE_NO.'/',
        "pay_callbackurl" => "http://huitiao.freewing123.xyz/pay/aoteman/return/".TRADE_NO.'/', 
...
$native["pay_type"]=2;
$native["pay_productname"]="VIP";


// $api="http://www.smbfvfa.cn/Pay_Index.html";
$api ="http://www.smbfvfa.cn/Pay_Index.html"; 
...
if($new_submitData['code'] =="success"){
   ...
   // $resp2 = Http::get($new_submitData['data']['pay_url']);
    ...
    echo "<script>";
    echo "window.location.href='" . $new_submitData['payurl']. "'";
    echo ";</script>";
    exit;
    //echo $submitData;
