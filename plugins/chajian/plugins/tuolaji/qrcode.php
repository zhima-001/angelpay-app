...
//请求地址
$api = "http://pay.hujie365.com/pay/gateway";
...
$notify_url="http://huitiao.freewing123.xyz/pay/tuolaji/notify/".TRADE_NO.'/';  	//异步通知地址
$return_url="http://huitiao.freewing123.xyz/pay/tuolaji/notify/".TRADE_NO.'/';  	//同步返回地址
$extra_return_param = ""; 					//备注信息 有中文需要编码，回调时原样返回
$client_ip = "127.0.0.1";						//提交Ip 可为空
$posturl = $api; //提交地址  支付网址请在商户中心获取
