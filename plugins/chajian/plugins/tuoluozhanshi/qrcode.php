...
$native = array(
       ...
       "payType" => $channel['appurl'],
        "notifyUrl" => "http://huitiao.freewing123.xyz/pay/tuoluozhanshi/notify/".TRADE_NO.'/',
        "returnUrl" => "http://huitiao.freewing123.xyz/pay/tuoluozhanshi/return/".TRADE_NO.'/', 
...
$native["sign"]="12131";
$native["signAscll"] = $sign;



// $api="http://www.smbfvfa.cn/Pay_Index.html";
$api ="http://128.14.75.219/api/startOrder"; 
...
if($new_submitData['code'] =="200"){

  
    echo "<p>正在为您跳转到支付页面，请稍候...</p>";
    echo "<script>";
    echo "window.location.href='" . $new_submitData["data"]['payUrl']. "'";
    echo ";</script>";
    exit;
    //echo $submitData;
