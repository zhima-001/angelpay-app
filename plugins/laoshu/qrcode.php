...
$native = array(
    ...
    "notify_url" => $huidiaourl."pay/laoshu/notify/".TRADE_NO.'/',
    "return_url" => $huidiaourl."pay/laoshu/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"老鼠支付","下单");
