...
//请求地址
$api = "http://8.134.93.182:8079/api/pay/create_order";
...
//     "pay_notifyurl" => "http://huitiao.freewing123.xyz/pay/gongxifacai/notify/".TRADE_NO.'/',
//     "pay_callbackurl" => "http://huitiao.freewing123.xyz/pay/gongxifacai/return/".TRADE_NO.'/', 
// );

//下订单支付
$native = array(
	'mchId' => $merId,//开户账号
	'appId' => "b953ba873e8f4112b89accab8d2ba9e8", 
	'mchOrderNo' => TRADE_NO,
	'notifyUrl' =>  "https://huitiao2.tshuitiao123.xyz/pay/juhezhifu/notify/".TRADE_NO.'/',
	'returnUrl' =>  "https://huitiao2.tshuitiao123.xyz/pay/juhezhifu/notify/".TRADE_NO.'/',
	'productId' => 8003,
...
if($arr['retCode'] =="SUCCESS"){
    ...
    echo "<script>";
    echo "window.location.href='" .  $arr['payParams']['codeUrl'] . "'";
    echo ";</script>";
    exit; 
}else{
    echo "拉取支付失败";
