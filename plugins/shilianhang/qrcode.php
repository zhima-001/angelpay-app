...
$native = array(
        ...
        "mchOrderNo" => TRADE_NO, 
        "notifyUrl" => $huidiaourl."pay/shilianhang/notify/".TRADE_NO.'/',
        "returnUrl"=>$huidiaourl."pay/shilianhang/return/".TRADE_NO.'/',
...
// exit();
$submitData = json_decode($submitData,true);
\lib\Zhifu::csasahangss(1,json_encode($submitData),"世联行支付","下单");
...
if($tg_beizhu == "Tg"){
 ...
 if($submitData['code'] =="0"){         
    ...
    $payUrl = $submitData['data']['payData'];
    $payurl =$payUrl;
