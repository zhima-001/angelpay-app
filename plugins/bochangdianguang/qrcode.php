...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/bochangdianguang/notify/".TRADE_NO.'/',
        "returnUrl"=>$huidiaourl."pay/bochangdianguang/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"波长电光支付","下单");
