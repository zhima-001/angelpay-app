...
$zhifu_url = $full_domain."/pay/changyuandianli/qrcode/{$trade_no}/";
...
echo "<script>window.location.href='/pay/changyuandianli/qrcode/{$trade_no}/?sitename={$sitename}';</script>";
