...
$native = array(
        ...
        "notice_url" => $huidiaourl."pay/changyuandianli/notify/".TRADE_NO.'/',
         "url"=>$huidiaourl."pay/changyuandianli/return/".TRADE_NO.'/',
         'calltype'=>"2",
         "chno"=>$channel['appurl'],
); 
ksort($native);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"长源电力支付","下单");
