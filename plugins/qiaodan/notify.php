...
//amount=100.00&body=vip&channel=zfb-ys&order_status=1&out_trade_no=2022102411471159817&trade_no=2022102411471159817&sign=328559370361d70887c290d0d7730f1a
$_REQUEST = $_POST;
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"乔丹支付","回调");
if($flag){
    //处理逻辑
