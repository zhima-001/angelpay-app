...
$native = array(
    ...
    "notify_url" => $huidiaourl."pay/quchenshi/notify/".TRADE_NO.'/',
    "return_url" => $huidiaourl."pay/quchenshi/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"屈臣氏支付","下单");
