...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/meijimu/notify/".TRADE_NO.'/',
        "pay_callbackurl" => $huidiaourl."pay/meijimu/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"美吉姆支付","下单");
$now_time2= time();
...
if($submitData['code'] == "200"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"美吉姆支付","异常通知");
