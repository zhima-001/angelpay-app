...
$native = array(
       "mchId"=>$merId,
        "appid"=>"0ae8be35ff634e2abe94f5f32f6d5c4f",
          "mchOrderNo" => TRADE_NO,
 ...
 "returnUrl" => $huidiaourl."pay/aerfa/return/".TRADE_NO.'/', 
        "notifyUrl" => $huidiaourl."pay/aerfa/notify/".TRADE_NO.'/',
         "subject"=>"vip",
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"阿尔法支付","下单");
