...
$native = array(
    ...
    //    "notifyUrl" => $huidiaourl."pay/sanan/notify/".TRADE_NO.'/',
          "notifyUrl" => $huidiaourl."huidiao.php/".TRADE_NO, 
        "returnUrl" => $huidiaourl."pay/sanan/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"三安支付","下单");
$now_time2= time();
...
if($submitData['retCode'] == "SUCCESS"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"三安支付","异常通知");
