...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/zhenengdianli/notify/".TRADE_NO.'/',
         "returnUrl"=>$huidiaourl."pay/zhenengdianli/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"浙能电力支付","下单");
