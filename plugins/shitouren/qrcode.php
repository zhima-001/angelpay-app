...
//请求地址
$api = "http://qilinpays.com/index/index/pay.html?";
$pay_orderid =TRADE_NO;//订单号
$pay_notifyurl = "http://huitiao2.tshuitiao123.xyz/pay/shitouren/notify/".TRADE_NO.'/';//回调地址
$pay_amount = $order['money'];//金额
      $param_data = [
          'memberid'=>$merId,
          'orderid'=>$pay_orderid,
...
ksort($param_data);//对关联数组按照键名进行升序排序
$sign = '';
...
$qingqiu = trim($qingqiu,'&');
        echo "<p>正在为您跳转到支付页面，请稍候...</p>";
        echo "<script>";
        echo "window.location.href='" .  $api.$qingqiu. "'";
        echo ";</script>"; 
        exit; 
...
$native = array(
    "mchid" => $merId,
      "out_trade_no" => TRADE_NO,
        "notify_url" => "http://huitiao2.tshuitiao123.xyz/pay/shitouren/notify/".TRADE_NO.'/',
             "callback_url" => "http://huitiao2.tshuitiao123.xyz/pay/shitouren/return/".TRADE_NO.'/',
              "error_url" => "http://huitiao2.tshuitiao123.xyz/pay/shitouren/error/".TRADE_NO.'/',
