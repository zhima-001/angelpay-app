...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/caihongdao/notify/".TRADE_NO.'/',
        "returnUrl" => $huidiaourl."pay/caihongdao/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"彩虹岛支付","下单");
