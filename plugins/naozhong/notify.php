...
$returnArray = array( // 返回字段
        "merchant_id" => $_REQUEST["merchant_id"], // 商户ID
        "request_time" =>  $_REQUEST["request_time"], // 订单号
        "pay_time" =>  $_REQUEST["pay_time"], // 交易金额
        "status" =>  $_REQUEST["status"], // 交易时间
        "order_amount" =>  $_REQUEST["order_amount"], // 流水号
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"闹钟支付","回调");
if($flag){
    //处理逻辑
    $out_trade_no  = $_REQUEST['out_trade_no'];
