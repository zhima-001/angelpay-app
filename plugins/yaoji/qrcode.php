...
$native = [
    ...
    'notifyUrl' =>$huidiaourl."pay/yaoji/notify/".TRADE_NO.'/',  //异步返回地址
    'returnUrl' =>$huidiaourl."pay/yaoji/return/".TRADE_NO.'/',    //同步返回地址
    'nonceStr' =>getRandom(32)   //随机字符串不超过32位
];
//生成签名 请求参数按照Ascii编码排序

$privateKey = "";

//私钥签名
$native['sign'] = sign($native,$md5key,$privateKey);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"妖姬支付","下单");
...
if($submitData['code'] == "0"){
    ...
    if($pccode == "1"){
        if(strpos($agent, 'iphone') || strpos($agent, 'android')){
            ...
            echo "<script>";
            echo "window.location.href='" .  $submitData['payUrl'] . "'";
            echo ";</script>";
            exit;  
         }else{
             if($shortlink == "1"){
