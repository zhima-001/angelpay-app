...
$native = array(
        ...
        "notify_url" => $huidiaourl."pay/nanyaxincai/notify/".TRADE_NO.'/',
        "return_url"=>$huidiaourl."pay/nanyaxincai/return/".TRADE_NO.'/',
        "money" => $order['money'],
        "name"=>"VIP",
