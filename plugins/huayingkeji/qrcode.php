...
$native = array(
        ...
        "notifyUrl" =>$huidiaourl."huidiao.php/".TRADE_NO, //$huidiaourl."huidiao.php/".TRADE_NO,
        "returnUrl" => $huidiaourl."pay/huayingkeji/return/".TRADE_NO.'/', 
...
// 将参数转为GET请求的URL
$queryString = http_build_query($native);
$url = $api . "?" . $queryString;

// 使用file_get_contents作为GET请求示例
$submitData = file_get_contents($url);
