...
$native = array(
    ...
    "mchNo"=>$merId,
    "mchOrderNo" => TRADE_NO,
     "payCode"=>$channel['appurl'],
    "payAmount" => $order['money']*100,
    'clientIp'=>getClientIP(0,true),
     "returnUrl"=>$huidiaourl."pay/chengfeijicheng/return/".TRADE_NO.'/',
    "notifyUrl" => $huidiaourl."huidiao.php/".TRADE_NO,
    //"notifyUrl" => $huidiaourl."pay/chengfeijicheng/notify/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"成飞集成支付","下单");
