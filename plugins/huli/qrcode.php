...
//请求地址
// $api = "http://103.235.174.120:8831/Pay_Index.html";
      ...
      "pay_orderid" => TRADE_NO,
         "pay_applydate" => date('Y-m-d H:i:s',time()),
            "pay_bankcode" => $channel['appurl'],
             "pay_notifyurl" => $huidiaourl."pay/huli/notify/".TRADE_NO.'/',
    "pay_callbackurl" => $huidiaourl."pay/huli/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"狐狸支付","下单");
if($tg_beizhu == "Tg"){
