...
$native = array(
    ...
    "desc"=>"VIP会员",
    "ip"=>$order['ip'], //支付端ip地址
    "callback_url" => "http://huitiao.freewing123.xyz/pay/wannianqing/notify/".TRADE_NO.'/',
    "callback_type" => "POST", 
    "ts"=>Http::getMillisecond(),
...
$sign = md5("key=".$merId.$md5key."&order_amount=".$order['money']."&order_no=".TRADE_NO."&pay_code=".$channel['appurl']."&ts=".Http::getMillisecond());
