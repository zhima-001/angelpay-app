...
$native = array(
        ...
        "notify_url" => $huidiaourl."pay/yonganyaoye/notify/".TRADE_NO.'/',
        "return_url"=>$huidiaourl."pay/yonganyaoye/return/".TRADE_NO.'/',
...
//echo '返回值:'.$resp;
  ...
  $submitData = json_decode($submitData['response'],true);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"永安药业支付","下单");
