...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/zhongguodianxin/notify/".TRADE_NO.'/', //$huidiaourl."huidiao.php/".TRADE_NO,
        "pay_callbackurl" => $huidiaourl."pay/zhongguodianxin/return/".TRADE_NO.'/', 
...
$native["pay_clientip"] = getClientIP(0,true);
