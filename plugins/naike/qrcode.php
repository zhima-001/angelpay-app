...
$native = array(
      ...
      //  "pay_applydate" =>date("Y-m-d H:i:s"),
        "trade_type" => $channel['appurl'],
      //  "notify_url" => $huidiaourl."pay/naike/notify/".TRADE_NO.'/',
  //  "return_url" => $huidiaourl."pay/naike/return/".TRADE_NO.'/', 
    "notify_url" => $huidiaourl."huidiao.php/".TRADE_NO,
         "total_amount" => $order['money']*100,
); 
ksort($native);
$md5str = "";
...
$native["sign"] = $sign;
$native['return_url'] =  $huidiaourl."pay/naike/return/".TRADE_NO.'/';
$native['interface_version']="V2.0";
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"耐克支付","下单");
