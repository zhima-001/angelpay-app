...
$native = array(
        ...
        "returnUrl" => $huidiaourl."pay/xiaopeng/return/".TRADE_NO.'/', 
         "money" => $order['money'],
         "productName"=>"cny",
         "accountName"=>"vip",
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"小鹏支付","下单");
...
if($submitData['state'] == "0"){
   ...
   $gaibian = $DB->exec("UPDATE pre_order SET shangyouzhifu='{$payurl2}' WHERE trade_no='".TRADE_NO."'");
    ...
    \lib\Zhifu::csasahangss(2,"单号:".TRADE_NO.":".json_encode($submitData),"小鹏支付","返回异常");
    var_dump($submitData);
    echo "拉取支付失败";
    exit();
}
