...
//请求地址
$api = "http://www.stationmasterpay.com/pay/api/order";


$native = array(
   "out_trade_id" => TRADE_NO, //商户订单号
   "amount" => $order['money'], //支付金额 单位元
    "notify_url" => "https://huitiao2.tshuitiao123.xyz/pay/mumu/notify/".TRADE_NO.'/', //异步回调 , 支付结果以异步为准
    "return_url" => "https://huitiao2.tshuitiao123.xyz/pay/mumu/return/".TRADE_NO.'/', //同步回调 不作为最终支付结果为准，请以异步回调为准

    "merchant_id" => $merId, //商户号
 
    "product_id" => $channel['appurl'], //支付类型 此处可选项为 微信公众号：wxgzh   微信H5网页：wxwap  微信扫码：wxsm   支付宝H5网页：zfbwap  支付宝扫码：zfbsm 等参考API
