...
$native = array(
        ...
        "notifyUrl" => $huidiaourl."pay/gaoneng/notify/".TRADE_NO.'/',
        "returnUrl" => $huidiaourl."pay/gaoneng/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"高能支付","下单");
$now_time2= time();
...
if($submitData['message'] == "ok"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"高能支付","异常通知");
