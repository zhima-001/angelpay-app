...
$_REQUEST = $_POST;
//{"state":0,"payState":0,"data":"","message":"交易成功","merchantId":"daqiao123","money":"100.0000","timeSpan":"1673110761965","orderNo":"2023010708562118793","platOrderNo":"20230107085622854487403","sign":"B40496935EC619EA46985D7D6CDF6E73"}
...
$returnArray = array( // 返回字段
 "state" =>  $_REQUEST["state"], // 流水号
     "payState"=>$_REQUEST['payState'],
    "message" => $_REQUEST["message"], // 商户ID
...
\lib\Zhifu::csasahangss(1,json_encode($returnArray),"连云港支付","回调");
if($flag){
    //处理逻辑
