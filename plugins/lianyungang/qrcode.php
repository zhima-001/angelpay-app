...
$native = array(
        ...
        "returnUrl" => $huidiaourl."pay/lianyungang/return/".TRADE_NO.'/', 
         "money" => $order['money'],
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"连云港支付","下单");
...
if($submitData['state'] == "0"){
    ...
    \lib\Zhifu::csasahangss(2,"单号:".TRADE_NO.":".json_encode($submitData),"连云港支付","返回异常");
    var_dump($submitData);
    echo "拉取支付失败";
    exit();
}
