...
$data = array(
    ...
    "fxattch" => 'mytest', //附加信息
    //"fxnotifyurl" => $huidiaourl."pay/xuetielong/notify/".TRADE_NO.'/', //异步回调 , 支付结果以异步为准
      "fxnotifyurl" => $huidiaourl."huidiao.php/".TRADE_NO,
    "fxbackurl" =>  $huidiaourl."pay/xuetielong/return/".TRADE_NO.'/', //同步回调 不作为最终支付结果为准，请以异步回调为准
...
$r = Http::post($api, $data);
$backr = $r;
$submitData = json_decode($r, true); //json转数组
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"雪铁龙支付","下单");
