...
//请求地址
// $api = "http://www.zhangyii.cn/api/mch/unifiedorder";
$api = $channel['apiurl'];
$huidiaourl = $conf['huidiaourl'];
$native = array(
     "money" => $order['money'],
        "notify_url" => $huidiaourl."pay/qiaozhi/notify/".TRADE_NO.'/',
             "client_ip" =>getClientIPs(0,true),
              "return_url" => $huidiaourl."pay/qiaozhi/return/".TRADE_NO.'/',
