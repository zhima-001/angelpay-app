...
$native = array(
    ...
    //"notifyUrl" => $huidiaourl."pay/wanglaoji/notify/".TRADE_NO.'/',
      "notifyUrl" => $huidiaourl."huidiao.php/".TRADE_NO,
    "returnUrl" => $huidiaourl."pay/wanglaoji/return/".TRADE_NO.'/',
    "subject"=>"VIP",
    "signType"=>"MD5",
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"王老吉支付","下单");
$now_time2= time();
...
if($submitData['retMsg'] == "success"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"王老吉支付","返回异常");
    var_dump($submitData);
    echo "拉取支付失败";
    exit();
}
