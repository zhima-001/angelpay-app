...
$native = array(
        ...
        "orderno" => TRADE_NO,
        "code" => $channel['appurl'],
     "async_notify_url" => $huidiaourl."pay/dongyalianshe/notify/".TRADE_NO.'/',
...
$content =aes_encrypt($encryptAesStr,"J92lnUUxJGtRuCFN");
$native2 = array(
   'mno'=> $merId,
   'content'=>$content
);
...
// echo "下单地址：".$api."<br>";
// echo "下单参数：".json_encode($native2)."<br>";
// echo "上游返回：".var_dump($submitData)."<br>";
// exit();
/*
1，下单后上游给我们的响应和返回
2，支付成功后，上游给我们的回调和响应
