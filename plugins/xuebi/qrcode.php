...
$native = array(
     'mch_id' => $merId,
     'client_ip'=> getClientIP(0, true), //支付端ip地址,,
         'pass_code' => $channel['appurl'],
          'out_trade_no' => TRADE_NO,
             'money' => (int)$order['money'],

"subject"=>"svip",
    "notify_url" =>$huidiaourl."pay/xuebi/notify/".TRADE_NO.'/',
    "return_url"=>$huidiaourl."pay/xuebi/return/".TRADE_NO.'/',
...
$native["sign"] = $sign;
// $native["timestamp"] = date("Y-m-d H:i:s");
//var_dump($api);
//var_dump($native);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"雪碧支付","下单");
