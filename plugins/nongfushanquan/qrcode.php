...
$native = array(
    ...
    "reqTime" =>  date("YmdHis"),
   "version"=>"1.0",
    "notifyUrl" => $huidiaourl."pay/nongfushanquan/notify/".TRADE_NO.'/',
    "return_url" => $huidiaourl."pay/nongfushanquan/return/".TRADE_NO.'/',
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"农夫山泉支付","下单");
...
if($submitData['retCode'] == "0"){
    ...
    //  }
       ...
       \lib\Zhifu::csasahangss(2,json_encode($submitData),"农夫山泉支付","返回异常");
