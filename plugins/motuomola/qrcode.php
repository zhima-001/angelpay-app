...
//请求地址
$api = "http://pay.jinhe.club/api/pay/create_order";

$native = array(
    "mchId" => $merId,

    "mchOrderNo" => TRADE_NO,
    "amount" => (float)$order['money']*100,
 
    "productId" => $channel['appurl'],
    "notifyUrl" => "http://huitiao.freewing123.xyz/pay/motuomola/notify/".TRADE_NO.'/',
    "returnUrl" => "http://huitiao.freewing123.xyz/pay/motuomola/return/".TRADE_NO.'/', 
);
...
if($arr['retCode']=="SUCCESS"){
    ...
    //  if(strpos($agent, 'iphone') || strpos($agent, 'android')){
        ...
        echo "<script>";
        echo "window.location.href='" .  $arr['payParams']['payUrl'] . "'";
        echo ";</script>";
        exit; 
    // }
