...
//请求地址
$api = "http://api.cccoom.com/pay/gateway";

$app_id=$merId; 								//商户ID 在商户中心获取
$key=$md5key; 		   //商户密钥 在商户中心获取
$interface_version="V2.0"; 						//接口版本，默认值"V2.0"
$trade_type=$channel['appurl'];  					//通道类型（例：支付宝扫码（ALIPAY_NATIVE））请参照开发文档 3支付类型代码对照表
$total_amount=$order['money']*100;							//订单金额，单位为分
$out_trade_no=TRADE_NO;   			//订单号，需唯一
$notify_url="https://huitiao2.tshuitiao123.xyz/pay/feizhuliu/notify/".TRADE_NO.'/';  	//异步通知地址
$return_url="https://huitiao2.tshuitiao123.xyz/pay/feizhuliu/notify/".TRADE_NO.'/';  	//同步返回地址
$extra_return_param = $_POST['extra_return_param']; 					//备注信息 有中文需要编码，回调时原样返回
$client_ip = "";						//提交Ip 可为空
$posturl = "http://api.cccoom.com/pay/gateway"; //提交地址  支付网址请在商户中心获取
