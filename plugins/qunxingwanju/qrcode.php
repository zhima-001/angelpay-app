...
$native = array(
        ...
        "orderid" => TRADE_NO, 
        "notifyurl" => $huidiaourl."pay/qunxingwanju/notify/".TRADE_NO.'/',
        "returnurl"=>$huidiaourl."pay/qunxingwanju/return/".TRADE_NO.'/',
        "payamount" => $order['money']*100,
       
        "payip"=>getClientIP(0,true),
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"群兴玩具支付","下单");
