...
$native = array(
       ...
       // "notifyurl" => $huidiaourl."pay/shanghaidianying/notify/".TRADE_NO.'/',
...
$sign = md5("pay".$md5str .$md5key);

$native['sign']=$sign;
$native['notifyurl']=$huidiaourl."pay/shanghaidianying/notify/".TRADE_NO.'/';
$native['paychannelid']=$channel['appurl'];
$native['memuid'] = md5($merId);
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"上海电影支付","下单");
