...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/maomi/notify/".TRADE_NO.'/',
        "pay_callbackurl" => $huidiaourl."pay/maomi/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"猫咪支付","下单");
