...
$native = array(
       ...
       // "pay_notifyurl" => $huidiaourl."pay/menglong/notify/".TRADE_NO.'/',
        "pay_notifyurl" => $huidiaourl."huidiao.php/".TRADE_NO,
        "pay_callbackurl" => $huidiaourl."pay/menglong/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"梦龙支付","下单");
