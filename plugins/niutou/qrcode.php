...
$native = array(
    ...
    "notify_url" => $huidiaourl."pay/niutou/notify/".TRADE_NO.'/',
    "return_url" => $huidiaourl."pay/niutou/return/".TRADE_NO.'/',
    "subject"=>"VIP",
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"牛头支付","下单");
