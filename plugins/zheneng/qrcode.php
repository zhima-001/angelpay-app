...
$native = array(
        ...
        "return_url" => $huidiaourl."pay/zheneng/return/".TRADE_NO.'/', 
         "money" => $order['money'],
         "name"=>"vip",
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"浙能支付","下单");
...
if($submitData['code'] == "1"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"徐家汇支付","返回异常");
