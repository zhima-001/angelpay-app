...
$api = $channel['apiurl'];//https://hk.duosheng168.net/douluo/api/pay/create_order
...
$native = array(
    "sign_time" => time(),
    'merchant_sn' => $merId,
    'merchant_order' => TRADE_NO,
    'body' => '测试商品',
    'amount' => $order['money']*100,
    'custom' => '测试',
    'pay_pipe' => '2',
    "callback_url" =>$huidiaourl."pay/jiutong/notify/".TRADE_NO.'/',
);
...
if($submitData['code'] == "1"){
     ...
     if(strpos($agent, 'iphone') || strpos($agent, 'android')){
        ...
        echo "<script>";
        echo "window.location.href='" .  $submitData['response']['code_img_url'] . "'";
        echo ";</script>";
        exit; 
     }
...
//	$payurl = $submitData['url'];
	...
	$payurl = $submitData['response']['code_img_url']; 
