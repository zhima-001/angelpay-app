...
$api = $channel['apiurl'];//https://gate.d14x4.com/api/gateway/create
$huidiaourl = $conf['huidiaourl'];

$data = array(
    'order_no'=>TRADE_NO,
             "async_url" => $huidiaourl."pay/huabanxie/notify/".TRADE_NO.'/',
    'extend'=>"123",
               "sync_url" => $huidiaourl."pay/huabanxie/return/".TRADE_NO.'/', 
       'channel'=>$channel['appurl'],
     "order_money" =>(int) $order['money']*100,
...
if($submitData['msg'] =="success"){
    
     $agent = strtolower($_SERVER['HTTP_USER_AGENT']);
     $submitData = json_decode(base64_decode($submitData['data']),true);
