...
//请求地址
$api = $channel['apiurl'];//http://apis2..haha555.xyz/api/pay/create_order
...
$notify_url=$huidiaourl."pay/tuolaji/notify/".TRADE_NO.'/';  	//异步通知地址
$return_url=$huidiaourl."pay/tuolaji/notify/".TRADE_NO.'/';  	//同步返回地址
