...
// echo "<script>window.location.href='/pay/tuolaji/qrcode/{$trade_no}/?sitename={$sitename}';</script>";
...
include 'function.php';
   ...
   $s = array(
        'code'=>200,
        'pay_url'=>"https://".$_SERVER['HTTP_HOST']."/pay/tuolaji/qrcode/{$trade_no}/?sitename={$sitename}"
    );
    echo json_encode($s);
    exit();
