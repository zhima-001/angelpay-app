...
$native = array(
        ...
        "pay_notifyurl" => $huidiaourl."pay/huada/notify/".TRADE_NO.'/',
        "pay_callbackurl" => $huidiaourl."pay/huada/return/".TRADE_NO.'/', 
...
\lib\Zhifu::csasahangss(1,json_encode($submitData),"华达支付","下单");
...
if($submitData['status'] == "1"){
    ...
    \lib\Zhifu::csasahangss(2,json_encode($submitData),"华达支付","异常通知");
